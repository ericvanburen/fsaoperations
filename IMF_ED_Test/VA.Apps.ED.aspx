    ...
    <form id="form1" runat="server">
                ...
                <legend class="fieldsetLegend">All VA Discharge Applications</legend><br />       
                   ...
                   <!--This one populates the Gridview-->
                            ...
                            SelectCommand="p_VAApps_ED" SelectCommandType="StoredProcedure" OnSelected="OnSelectedHandler" />
                            
                            <asp:SqlDataSource ID="dsVAApps_NoCompleted" runat="server" 
                            ConnectionString="<%$ ConnectionStrings:ConnectionString_IMF_SQL %>" 
                            SelectCommand="p_VAApps_ED_NoCompleted" SelectCommandType="StoredProcedure" OnSelected="OnSelectedHandler" />                        
                            
                            <div align="center" width="90%">
                            <asp:CheckBox ID="chkIncludeCompleted" runat="server" AutoPostBack="true" 
                                    oncheckedchanged="chkIncludeCompleted_CheckedChanged" /> Include Completed VA discharge apps? - <asp:Label ID="lblRecordCount" runat="server" CssClass="warningMessage" />
                            </div>
                            <div class="grid"> 
