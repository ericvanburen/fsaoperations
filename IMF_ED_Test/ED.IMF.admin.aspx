...
<script runat="server">
    ...
    Sub btnAddIMF_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        cmd.Parameters.AddWithValue("@IMF_Owner", "ED")
        Try
            strConnection.Open()
            cmd.Connection = strConnection
            cmd.ExecuteNonQuery()
...
<body>
    ...
    <tr>
        ...
        <tr>
            <td class ="formLabelForm" >IMF Type: </td>
            <td><asp:Textbox ID="txtIMF_Type" runat="server" Columns="60" /></td>              
        </tr>
        <tr>
         ...
         <tr>
            <td colspan="2" align="center"><br /><asp:Button ID="btnUpdateIMF" runat="server" Text="Update IMF Type" OnClick="btnUpdateIMF_Click" CssClass="button" onmouseover="this.className='button buttonhover'" onmouseout="this.className='button'" /></td>
        </tr> 
        <tr>
    ...
    <table border="0">
       <tr>
            <td class ="formLabelForm" >IMF Type: </td>
            <td><asp:Textbox ID="txtIMF_TypeAdd" runat="server" Columns="60" /></td>              
        </tr>
        <tr>
            <td class ="formLabelForm" >IMF Type Description: </td>
         ...
         <tr>
            <td colspan="2" align="center"><br /><asp:Button ID="btnAddIMD" runat="server" Text="Add New IMF Type" OnClick="btnAddIMF_Click" CssClass="button" onmouseover="this.className='button buttonhover'" onmouseout="this.className='button'" /></td>
        </tr> 
        <tr>
