...
<script runat="server">
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs)
        If Not IsPostBack Then
            ...
            If Not IsNothing(Request.Cookies("IMF")) Then
                ...
                'Bind the ReassignedTo dropdownlist
                ddlReassignTo.Items.Add("")
                ddlReassignTo.AppendDataBoundItems = True
                ddlReassignTo.DataSource = dsEDUsers()
                ddlReassignTo.DataTextField = "Username"
                ddlReassignTo.DataValueField = "UserID"
    ...
    Sub btnReassignIMFs_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If i = 0 Then
            lblReassignStatus.Text = "You must check at least one record to reassign it to another analyst"
        Else
            lblReassignStatus.Text = "Your IMFs have been reassigned to a new analyst"
        End If
    ...
    Sub ReassignIMFs(ByVal ID As Integer, ByVal UserID As Integer)
        ...
        strSql = "p_ReassignIMFs"
        cmd = New SqlCommand(strSql)
        cmd.CommandType = CommandType.StoredProcedure
        
        cmd.Parameters.AddWithValue("@ID", SqlDbType.Int).Value = ID
        cmd.Parameters.AddWithValue("@UserID", SqlDbType.Int).Value = UserID
        cmd.Parameters.AddWithValue("@DateReassigned", SqlDbType.SmallDateTime).Value = DateTime.Now
        Try
            strConnection.Open()
