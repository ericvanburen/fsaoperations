...
<script runat="server">
    ...
    Sub btnExportPDF_Click(ByVal sender As Object, ByVal e As EventArgs)
        Response.Redirect("https://www.fsacollections.ed.gov/secure/imf_ed/pdf/SSU.DEA.aspx?AG=" & lblAgency.Text & "&BeginDate=" & txtBeginDate.Text & "&EndDate=" & txtEndDate.Text)
    End Sub
...
<body>
    ...
    <asp:SqlDataSource ID="dsVA_Discharge_Approval_Letter" runat="server" 
              ...
              SelectCommand="p_SSU_DEA" SelectCommandType="StoredProcedure">
         <SelectParameters>
            ...
            <td colspan="4"><asp:Button ID="btnSearch" OnClick="btnSearch_Click" Text="Search" CssClass="button" runat="server" /></td>
                 ...
                 <asp:Panel ID="pnlSSU" runat="server" Visible="false">
                     ...
                     <tr>
                        ...
                        <td align="left" style="width:100px"> <asp:Label ID="lblAgency" runat="server" /></td>
                     </tr>
                     </ItemTemplate>
