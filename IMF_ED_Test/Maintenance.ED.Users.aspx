...
<script runat="server">
    ...
    Dim blnIsActive, blnIsAdmin, blnIsPCAUser, blnProcessVAApps, blnProcessComplaints As Boolean
    ...
    Sub BindUserName()
        ...
        Try
            ...
            While dr.Read()
                ...
                If IsDBNull(dr("ProcessComplaints")) = False Then
                    blnProcessComplaints = dr("ProcessComplaints")
                End If
            ...
            chkIsAdmin.DataBind()
            chkIsPCAUser.DataBind()
            chkProcessVAApps.DataBind()
            chkProcessComplaints.DataBind()
    ...
    Protected Sub btnUpdateUser_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        cmd.Parameters.AddWithValue("@IsPCAUser", chkIsPCAUser.Checked)
        cmd.Parameters.AddWithValue("@ProcessVAApps", chkProcessVAApps.Checked)
        cmd.Parameters.AddWithValue("@ProcessComplaints", chkProcessComplaints.Checked)
        cmd.Parameters.AddWithValue("@UserID", lblUserID.Text)
        Try
            strConnection.Open()
            cmd.Connection = strConnection
...
<head id="Head1" runat="server">
    <title>ED User Administration & IMF Assignments</title>
...
<body>
    ...
    <fieldset>
    <legend class="fieldsetLegend">ED User Administration & IMF Assignments</legend><br />    
    <div align="left">
    <table border="0">
    <tr>
            <td class ="formLabelForm">User name:</td>
            <td>  <asp:DropDownList id="ddlAllUsers" Runat="Server"                               
                                DataTextField="UserName" DataSourceID="dsAllUsers" 
        ...
        <tr>
            ...
            <td><asp:CheckBox ID="chkIsAdmin" runat="server" Checked='<%# blnIsAdmin %>' /></td>            
        </tr>        
         <tr>
            <td class ="formLabelForm">User Can Process VA Discharge Apps?</td>
            <td><asp:CheckBox ID="chkProcessVAApps" runat="server" Checked='<%# blnProcessVAApps %>' /></td>            
        </tr>
        <tr>
            <td class ="formLabelForm">User Can Process Borrower Complaints?</td>
            <td><asp:CheckBox ID="chkProcessComplaints" runat="server" Checked='<%# blnProcessComplaints %>' /></td>            
        </tr>
         <tr>
            <td class ="formLabelForm">User Can Process New PCA Employee Requests?</td>
            <td><asp:CheckBox ID="chkIsPCAUser" runat="server" Checked='<%# blnIsPCAUser %>' /></td>            
        </tr>       
        <tr>
        ...
        <tr>
            ...
            <tr>
            <td colspan="2" align="left"><br /><a href="MyIMFs.ED.aspx?UserID=<%=lblUserID.Text %>&Username=<%=ddlAllUsers.SelectedItem %>">All IMFs Assigned to this Analyst</a></td>
        </tr>
