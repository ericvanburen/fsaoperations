...
Partial Class _SSUDEA
    ...
    Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs)
        If Not Page.IsPostBack Then
            ...
            urlToConvert = "http://10.59.110.59/secure/imf_ed/pdf/SSU.DEA.Search.aspx?AG=" & strAG & "&BeginDate=" & dteBeginDate & "&EndDate=" & dteEndDate & "&SSU_Type=" & strSSU_Type
