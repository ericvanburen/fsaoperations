...
Partial Class _Default
    ...
    Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs)
        If Not Page.IsPostBack Then
            ...
            Dim strApprovalType As String = Request.QueryString("ApprovalType").Trim().ToString()
            Dim urlToConvert As String = ""
            If strApprovalType = "Approved" Then
                urlToConvert = "http://10.59.110.59/secure/imf_ed/pdf/VA.Approval.aspx?ID=" & ID
            ElseIf strApprovalType = "NotApproved" Then
                urlToConvert = "http://10.59.110.59/secure/imf_ed/pdf/VA.NonApproval.aspx?ID=" & ID
            End If
    ...
    Sub ConvertURLToPDF(ByVal urlToConvert As String)
        ...
        Response.AddHeader("Content-Disposition", "attachment; filename=VA.Discharge.Letter.pdf; size=" & pdfBytes.Length.ToString())
        Response.Flush()
