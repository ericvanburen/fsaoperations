...
<head runat="server">
    <title>PCA Requests By IMF Status</title>
...
<body>
    <form id="form1" runat="server">
                      ...
                      <asp:SqlDataSource ID="dsReport_Status" runat="server" 
                            ConnectionString="<%$ ConnectionStrings:ConnectionString_IMF_SQL %>" 
                            SelectCommand="p_Report_Vangent_Status" SelectCommandType="StoredProcedure">
                            <SelectParameters>
                      ...
                      <fieldset>
                        <legend class="fieldsetLegend">Report By Status</legend><br />
                      ...
                      <p> </p>
                        <div class="grid">                          
                            <asp:GridView ID="GridView1" runat="server" DataSourceID="dsReport_Status" AutoGenerateColumns="false" CellPadding="4" 
                            ...
                            <asp:BoundField DataField="StatusCount" HeaderText="Count" SortExpression="StatusCount" />                           
                            </Columns>
                            </asp:GridView>
                    </div>
                    </fieldset>
