...
<script runat="server">
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs)
        If Not IsPostBack Then
            ...
            If Not IsNothing(Request.Cookies("IMF")) Then
                ...
                lbQueueID.Items.Add("")
                lbQueueID.AppendDataBoundItems = True
                lbQueueID.DataSource = dsAllDRGQueues()
                lbQueueID.DataTextField = "QueueName"
                lbQueueID.DataValueField = "QueueID"
                lbQueueID.DataBind()
            End If
        End If
    End Sub
    ...
    Sub BindGridView()
        ...
        If txtDateAssignedLessThan.Text <> "" Then
            cmd.Parameters.AddWithValue("@DateAssignedLessThan", SqlDbType.VarChar).Value = PreventSQLInjection(txtDateAssignedLessThan.Text)
        End If
                  ...
                  <!--This one populates the DRG Queues dropdown-->
                      <asp:SqlDataSource ID="dsAllDRGQueues" runat="server" 
                        ...
                        <tr>
                            ...
                            <td align="left" width="50%" valign="middle">
                            <asp:Listbox id="lbQueueID" Runat="Server" 
                            SelectionMode="Multiple" 
                            Rows="3" Width="150px" 
                            CssClass="formLabel" />
                            </td>
                           ...
                           <tr>
                            ...
                            <tr>
                                <td align="right" width="50%" class="formLabel">Date Assigned:</td>
                                <td align="left" width="50%" class="smallText">: 
                                <asp:Textbox ID="txtDateAssignedLessThan" runat="server" CssClass="formLabel" />  (less than)</td>
                            </tr>                       
                            <tr>
