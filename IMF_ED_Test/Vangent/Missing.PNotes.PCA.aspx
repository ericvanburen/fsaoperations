...
<script runat="server">
    ...
    Sub BindGridView_NoCompleted()
        ...
        con = New SqlConnection(ConfigurationManager.ConnectionStrings("ConnectionString_IMF_SQL").ConnectionString)
        strSQL = "p_PNotes_PCA_NoCompleted"
        cmd = New SqlCommand(strSQL)
        cmd.CommandType = CommandType.StoredProcedure
        cmd.Parameters.AddWithValue("@AG", SqlDbType.VarChar).Value = lblAgency.Text
        cmd.Connection = con
    ...
    Private Sub btnExportExcel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If chkIncludeCompleted.Checked Then
            'If its checked, then show all missing Pnote requests
            GridView1.DataSourceID = Nothing
            BindGridView_Completed()
        Else
            'Only show those missing Pnote requests which has not been completed
            GridView1.DataSourceID = Nothing
...
<head id="Head1" runat="server">
    <title>Missing PNote Requests - PCA</title>
    ...
    <form id="form1" runat="server">
                ...
                <legend class="fieldsetLegend">All PNote Requests</legend><br />       
                   ...
                   <!--This one populates the Gridview-->
                            ...
                            SelectCommand="p_PNotes_PCA" SelectCommandType="StoredProcedure"                                  
                            ...
                            ConnectionString="<%$ ConnectionStrings:ConnectionString_IMF_SQL %>" 
                            SelectCommand="p_PNotes_PCA_NoCompleted" SelectCommandType="StoredProcedure" OnSelected="OnSelectedHandler">
                              <SelectParameters>
                                <asp:ControlParameter ControlID="lblAgency" Name="AG" />                            
                            </SelectParameters>                           
                             </asp:SqlDataSource>                        
