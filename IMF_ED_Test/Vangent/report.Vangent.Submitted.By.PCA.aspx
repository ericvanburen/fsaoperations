...
<head runat="server">
    <title>IMFs Submitted By PCA Summary</title>
...
<body>
    <form id="form1" runat="server">
                      ...
                      <asp:SqlDataSource ID="dsIMFs_Submitted_Report" runat="server" 
                            ...
                            SelectCommand="p_IMFs_Submitted_Report_Vangent" SelectCommandType="StoredProcedure">
                            <SelectParameters>
                      ...
                      <fieldset>
                        <legend class="fieldsetLegend">IMFs Submitted By PCA Summary</legend><br />
                      ...
                      <p> </p>
                        <div class="grid">                          
                            ...
                            <asp:BoundField DataField="AG_Name" HeaderText="PCA Name" SortExpression="AG_Name" />
                            <asp:BoundField DataField="IMF_Type" HeaderText="Request Type" SortExpression="IMF_Type" />
                            <asp:BoundField DataField="TotalSubmitted" HeaderText="Total Submitted" SortExpression="TotalSubmitted" />                    
                            </Columns>
                            </asp:GridView>
                    </div>
                    </fieldset>
