...
<script runat="server">
    ...
    Sub BindGridView_NoCompleted()
        ...
        con = New SqlConnection(ConfigurationManager.ConnectionStrings("ConnectionString_IMF_SQL").ConnectionString)
        strSQL = "p_MyIMFs_PCA_Vangent_NoCompleted"
        cmd = New SqlCommand(strSQL)
        cmd.CommandType = CommandType.StoredProcedure
        cmd.Parameters.AddWithValue("@AgencyID", SqlDbType.Varchar).Value = lblAgency.Text
        cmd.Connection = con
...
<body>
    <form id="form1" runat="server">
                ...
                <asp:SqlDataSource ID="dsMyIMFs_NoCompleted" runat="server" 
                    ...
                    SelectCommand="p_MyIMFs_PCA_Vangent_NoCompleted" SelectCommandType="StoredProcedure" OnSelected="OnSelectedHandler">
                        <SelectParameters>
                    ...
                    ConnectionString="<%$ ConnectionStrings:ConnectionString_IMF_SQL %>" 
                    SelectCommand="p_MyIMFs_PCA_Vangent" SelectCommandType="StoredProcedure" OnSelected="OnSelectedHandler">
                        <SelectParameters>
                            <asp:ControlParameter ControlID="lblAgency" Name="AgencyID" />                            
                        </SelectParameters>
                     </asp:SqlDataSource>
                  ...
                  <div align="center">     
                      <h2>My IMFs (<%=lblAgency.Text%>) - DRG</h2>
