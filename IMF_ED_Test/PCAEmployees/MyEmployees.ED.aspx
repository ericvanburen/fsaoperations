...
<body>
    <form id="form1" runat="server">
                ...
                <asp:SqlDataSource ID="dsMyEmployees" runat="server" 
                  ...
                  <div align="center">     
                      <h2>All PCA Employees</h2>
                        <asp:Panel ID="pnlMyEmployees" runat="server">                                        
                           <div align="center" width="90%">
                           <table>
                            <tr>
                                <td><a href="MyEmployees.ED.All.Filter.aspx">Filter this list</a></td>
                            </tr>
                            <tr>
                                <td align="left"><asp:Label ID="lblRecordCount" runat="server" CssClass="warningMessage" /></td>
                            </tr>
                           </table> 
                            </div>
                            <div class="grid">
