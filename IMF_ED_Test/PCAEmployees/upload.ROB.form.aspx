...
<script runat="server">
    ...
    Protected Sub btnUploadForm_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        strSql = "p_PCAEmployeeUploadROBForm"
        ...
        If strFileNamePath.Length > 0 Then
            ...
            'strSaveLocation = "D:\DCS\secure\IMF_ED\x49g\pca\employees\rob\" & strFileNameOnly
            strSaveLocation = lblUploadPath.Text & "pca\employees\rob\" & strFileNameOnly
            Filebox.PostedFile.SaveAs(strSaveLocation)
            cmd.Parameters.Add("@ROB_Attachment", SqlDbType.VarChar).Value = strFileNameOnly
        Else
            cmd.Parameters.Add("@ROB_Attachment", SqlDbType.VarChar).Value = DBNull.Value
        End If
        ...
        lblUpdateStatus.Text = "Your ROB form has been received. Please click the Close Window button to return to the Employee Details screen."
    ...
    Sub ResetAcceptFormValue()
        ...
        cmd.CommandType = CommandType.StoredProcedure
        cmd.Parameters.AddWithValue("@ID", lblID.Text)
        cmd.Parameters.AddWithValue("@FormType", "ROB")
...
<head runat="server">
    <title>Upload Rules of Behavior (ROB) Form</title>
...
<body>
    <form id="form1" runat="server">
     <fieldset>
    <legend class="fieldsetLegend">Upload Rules of Behavior (ROB) Form</legend><br />    
    <div align="left">
    <table>
    <tr>
            <td class ="formLabel" width="50%" >Date Rules of Behavior (ROB) Completed:</td>
            <td width="50%" ><asp:Textbox ID="txtROB_Date" runat="server"  /> (mm/dd/yyyy)<br />
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1"
                    runat="server" ErrorMessage="* This field is required * " CssClass="warningMessage" Display="Dynamic" ControlToValidate="txtROB_Date" />
                    <asp:CompareValidator ID="dateValidator" runat="server" Type="Date" Operator="DataTypeCheck" ControlToValidate="txtROB_Date" ErrorMessage="* Please enter a valid date (mm/dd/yyyy) *" CssClass="warningMessage" Display="Dynamic" /></td>              
    </tr>        
    <tr>
            <td align="right" width="50%" class="formLabel">Click Browse to Upload Form:</td>
             ...
             <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="* Please click Browse to upload your ROB form *" Display="Dynamic" CssClass="warningMessage" ControlToValidate="Filebox" /></td>
     </tr>
     <tr>
