...
<script runat="server">
    ...
    Sub BindGridView()
        ...
        strSQL = "p_MyEmployees_PCA_FormsNotApproved"
...
<head id="Head1" runat="server">
    <title>PCA Employees - Rejected Forms</title>
...
<body>
    <form id="form1" runat="server">
                ...
                <asp:SqlDataSource ID="dsMyEmployees" runat="server" 
                    ...
                    SelectCommand="p_MyEmployees_PCA_FormsNotApproved" SelectCommandType="StoredProcedure" OnSelected="OnSelectedHandler">
                        <SelectParameters>
                  ...
                  <div align="center">     
                      <h2>My Employees (<%=lblAgency.Text%>) - Rejected Forms</h2>
                        <asp:Panel ID="pnlMyEmployees" runat="server">                                        
                           <div align="center" width="90%">
                            ...
                            <EmptyDataTemplate>
                                    You have no employees with rejected forms
                            </EmptyDataTemplate>
                            ...
                            <Columns>
                                ...
                                <asp:HyperLinkField 
                                   ...
                                   <asp:BoundField 
                                    DataField="PAT_Attachment_Accepted_By_ED" 
                                    HeaderText="PA Attachment Accepted"
                                    SortExpression="PAT_Attachment_Accepted_By_ED"
                                    ItemStyle-HorizontalAlign="Left" /> 
                                    
                                    <asp:BoundField 
                                    DataField="SAT_Attachment_Accepted_By_ED" 
                                    HeaderText="SAT Attachment Accepted"
                                    SortExpression="SAT_Attachment_Accepted_By_ED"
                                    ItemStyle-HorizontalAlign="Left" />
                                    
                                    <asp:BoundField 
                                    DataField="IRT_Attachment_Accepted_By_ED" 
                                    HeaderText="IRT Attachment Accepted"
                                    SortExpression="IRT_Attachment_Accepted_By_ED"
                                    ItemStyle-HorizontalAlign="Left" />
                                    
                                    <asp:BoundField 
                                    DataField="ROB_Attachment_Accepted_By_ED" 
                                    HeaderText="ROB Attachment Accepted"
                                    SortExpression="ROB_Attachment_Accepted_By_ED"
                                    ItemStyle-HorizontalAlign="Left" />                        
