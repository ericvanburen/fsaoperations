...
function openWindowPAT(ID) {
    window.open("upload.PAT.form.aspx?ID=" + ID, "mywindow", "location=1,status=1,scrollbars=1,width=460,height=240");
}
...
function openWindowDMCSROB(ID) {
    window.open("upload.DMCSROB.form.aspx?ID=" + ID, "mywindow", "location=1,status=1,scrollbars=1,width=510,height=220");
}

function openWindowDMCSAccess(ID) {
    window.open("upload.DMCSAccess.form.aspx?ID=" + ID, "mywindow", "location=1,status=1,scrollbars=1,width=510,height=220");
}
    ...
    <tr>
        ...
        <td style="width: 25%">
            <asp:DropDownList ID="ddlEmployeeFunction" runat="server" CssClass="formLabel" SelectedValue='<%# Eval("EmployeeFunction") %>'>
                    ...
                    <asp:ListItem Text="Collector" Value="Collector" />
    ...
    <tr>
        ...
        <td colspan="4">
            <ul id="listLinks" runat="server">                                                                      
                   ...
                   <li id="l7" runat="server"><asp:HyperLink ID="HyperLink7" NavigateUrl='<%# Eval("DMCS_ROB_Attachment")%>' runat="server"></asp:HyperLink></li>
                   <li id="l8" runat="server"><asp:HyperLink ID="HyperLink8" NavigateUrl='<%# Eval("DMCS_Access_Attachment")%>' runat="server"></asp:HyperLink></li> 
            </ul> 
        </td>
        </tr>        
        <tr>
