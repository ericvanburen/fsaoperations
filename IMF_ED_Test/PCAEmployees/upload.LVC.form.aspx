...
<script runat="server">
    ...
    Protected Sub btnUploadForm_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        strSql = "p_PCAEmployeeUploadLVCForm"
        cmd = New SqlCommand(strSql)
        cmd.CommandType = CommandType.StoredProcedure
        
        cmd.Parameters.AddWithValue("@ID", lblID.Text)
        cmd.Parameters.AddWithValue("@LVC_Date", txtLVC_Date.Text)
        ...
        If strFileNamePath.Length > 0 Then
            ...
            'strSaveLocation = "D:\DCS\secure\IMF_ED\x49g\pca\employees\lvc\" & strFileNameOnly
            strSaveLocation = lblUploadPath.Text & "pca\employees\lvc\" & strFileNameOnly
            Filebox.PostedFile.SaveAs(strSaveLocation)
            cmd.Parameters.Add("@LVC_Attachment", SqlDbType.VarChar).Value = strFileNameOnly
        Else
            cmd.Parameters.Add("@LVC_Attachment", SqlDbType.VarChar).Value = DBNull.Value
        End If
        ...
        lblUpdateStatus.Text = "Your LVC form has been received. Please click the Close Window button to return to the Employee Details screen."
    ...
    Sub ResetAcceptFormValue()
        ...
        cmd.CommandType = CommandType.StoredProcedure
        cmd.Parameters.AddWithValue("@ID", lblID.Text)
        cmd.Parameters.AddWithValue("@FormType", "LVC")
...
<body>
    <form id="form1" runat="server">
     <fieldset>
    <legend class="fieldsetLegend">Upload LVC Form</legend><br />    
    <div align="left">
    <table>
    <tr>
            <td class ="formLabel" width="50%" >Date LVC Certification Completed:</td>
            <td width="50%" ><asp:Textbox ID="txtLVC_Date" runat="server"  /> (mm/dd/yyyy)<br />
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1"
                    runat="server" ErrorMessage="* This field is required * " CssClass="warningMessage" Display="Dynamic" ControlToValidate="txtLVC_Date" />
                    <asp:CompareValidator ID="dateValidator" runat="server" Type="Date" Operator="DataTypeCheck" ControlToValidate="txtLVC_Date" ErrorMessage="* Please enter a valid date (mm/dd/yyyy) *" CssClass="warningMessage" Display="Dynamic" /></td>              
    </tr>        
    <tr>
            <td align="right" width="50%" class="formLabel">Click Browse to Upload LVC Form:</td>
             <td align="left" width="50%"><input id="Filebox" type="File" runat="server" size="35" class="button" /><br />
             <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="* Please click Browse to upload your LVC form *" Display="Dynamic" CssClass="warningMessage" ControlToValidate="Filebox" /></td>
     </tr>
     <tr>
