...
<script runat="server">
    ...
    Sub BindGridView()
        ...
        If ddlPAT_Attachment_Accepted_By_ED.SelectedValue <> "" Then
            cmd.Parameters.AddWithValue("@PAT_Attachment_Accepted_By_ED", SqlDbType.VarChar).Value = ddlPAT_Attachment_Accepted_By_ED.SelectedValue
        End If
                    ...
                    <!--This one populates the Agency dropdown-->
                      <asp:SqlDataSource ID="dsAgencies" runat="server" 
                        ...
                        <tr>
                             ...
                             <tr>
                                 <td align="right" class="formLabel" width="50%">
                                     Date Original PAT Completed:</td>
                                 <td align="left" class="smallText" width="50%">
                       ...
                       <asp:Label ID="lblRowCount" runat="server" />
                            ...
                            <Columns>
                                <asp:HyperLinkField 
                                    ...
                                    HeaderText="PAT Date Completed" 
                                    SortExpression="PAT_Date_Original" 
                                    DataFormatString="{0:d}" /> 
                                    
                                    <asp:BoundField 
                                    DataField="PAT_Date_Last" 
                                    HeaderText="Last PAT Date Completed" 
                                    SortExpression="PAT_Date_Last" 
                                    DataFormatString="{0:d}" />
                                    
                                    <asp:BoundField 
                                    DataField="SAT_Date" 
                                    HeaderText="SAT Date Completed" 
                                    SortExpression="SAT_Date" 
                                    DataFormatString="{0:d}" /> 
                                    
                                     <asp:BoundField 
                                    DataField="IRT_Date" 
                                    HeaderText="IRT Date Completed" 
