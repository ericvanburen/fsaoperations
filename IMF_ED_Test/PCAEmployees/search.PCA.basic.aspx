...
<script runat="server">
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs)
        If Not IsPostBack Then
            ...
            ddlAgencies.SelectedValue = lblAgency.Text
    ...
    Sub BindGridView()
        ...
        If ddlAgencies.SelectedValue <> "" Then
            cmd.Parameters.AddWithValue("@AG", SqlDbType.VarChar).Value = ddlAgencies.SelectedValue
        End If
                    ...
                    <!--This one populates the Agency dropdown-->
                      <asp:SqlDataSource ID="dsAgencies" runat="server" 
                        ...
                        <tr>
                            ...
                            SelectionMode="Single" Width="75px" 
                            CssClass="formLabel" Enabled="False" />
                            </td>
                        </tr>  
                         <tr>
