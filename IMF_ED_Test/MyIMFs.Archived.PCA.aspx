<%@ Page Language="VB" Inherits="MyBaseClass" src="classes/MyBaseClass.vb" MaintainScrollPositionOnPostback="true" EnableEventValidation="false" %>
...
<body>
    <form id="form1" runat="server">
                ...
                <asp:SqlDataSource ID="dsMyIMFs_Archived" runat="server" 
                    ConnectionString="<%$ ConnectionStrings:ConnectionString_IMF_SQL %>" 
                    SelectCommand="p_MyIMFs_Archived_PCA" SelectCommandType="StoredProcedure" OnSelected="OnSelectedHandler">
                        <SelectParameters>
                  ...
                  <div align="center">     
                      <h2>My Archived IMFs (<%=lblAgency.Text%>)</h2>
                        <asp:Panel ID="pnlMyIMFs" runat="server">                                        
                            <div align="center" width="90%">
                                    <asp:Label ID="lblRecordCount" runat="server" CssClass="warningMessage" />
                            </div>
                            <div class="grid">
                            <asp:GridView ID="GridView1" runat="server" DataKeyNames="id" DataSourceID="dsMyIMFs_Archived" AutoGenerateColumns="false" CellPadding="4" 
                            ...
                            <EmptyDataTemplate>
                                    Your agency does not have any archived IMFs
                            </EmptyDataTemplate>
