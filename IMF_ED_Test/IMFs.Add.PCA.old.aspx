...
<script runat="server">
    ...
    Sub btnSubmitIMF_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        'If its vangent then we jump right to the InsertIMF_Vangent
    ...
    Sub GetRandom_EDUser()
        ...
        cmd.Parameters.AddWithValue("@AG", SqlDbType.Int).Value = Convert.ToInt32(lblAgency.Text)
        Try
            con.Open()
            cmd.Connection = con
            dr = cmd.ExecuteReader()
    ...
    Sub InsertNewIMF()
        ...
        If strFileNamePath.Length > 0 Then
            ...
            strFileNameOnly = lblAgency.Text & "." & System.IO.Path.GetFileName(Filebox.PostedFile.FileName)
            ...
            strSaveLocation = "d:\DCS\secure\IMF_ED\x49g\" & strFileNameOnly
            Filebox.PostedFile.SaveAs(strSaveLocation)
            cmdInsert.Parameters.Add("@Attachment1", SqlDbType.VarChar).Value = "https://www.fsacollections.ed.gov/secure/IMF_ED/x49g/" & strFileNameOnly
        Else
        ...
        If strFileNamePath2.Length > 0 Then
            ...
            'Append the agency value before the file name       
            strFileNameOnly2 = lblAgency.Text & "." & System.IO.Path.GetFileName(Filebox2.PostedFile.FileName)
            'strFileNameOnly2 = System.IO.Path.GetFileName(Filebox2.PostedFile.FileName)
            
            'This checks for a valid file name and type
            Dim Filename2Regex As New Regex("(.*?)\.(doc|docx|pdf|xls|xslt|bmp|tif|jpg|txt|gif|png)$")
            ...
            strSaveLocation2 = "d:\DCS\secure\IMF_ED\x49g\" & strFileNameOnly2
            Filebox.PostedFile.SaveAs(strSaveLocation2)
            cmdInsert.Parameters.Add("@Attachment2", SqlDbType.VarChar).Value = "https://www.fsacollections.ed.gov/secure/IMF_ED/x49g/" & strFileNameOnly2
        Else
        ...
        cmdInsert.Parameters.AddWithValue("@LocationCode", SqlDbType.VarChar).Value = txtLocationCode.Text
    ...
    Sub InsertNewIMF_Vangent()
        ...
        Try
            con.Open()
            intReturnIMF_ID = cmdInsert.ExecuteScalar()
            lblStatus.Text = "Your IMF has been received by Vangent. Your request number is " & intReturnIMF_ID
    ...
    Sub btnSubmitAnotherIMF_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        txtComments.Text = ""
        txtDebtID.Text = ""
        txtPCA_Employee.Text = ""
        txtPCA_Phone.Text = ""
        lblStatus.Text = ""
        ddlIMF_Type.SelectedValue = 1
        
        'Hide the SubmitAnotherIMF Button
        btnSubmitAnotherIMF.Visible = False
        
        'Show the regular submit IMF button
        btnSubmitIMF.Visible = True
                   ...
                   <asp:Panel ID="pnlIMFEntry" runat="server">
                        ...
                        <table border="0" width="900" style="padding-left: 15px">
                            ...
                            <tr>
                                ...
                                <td align="left" width="50%">
                                <asp:TextBox ID="txtDebtID" runat="server" MaxLength="16" CssClass="formLabel" />
                                <asp:RequiredFieldValidator ID="rf_DebtID" runat="server" ControlToValidate="txtDebtID" Display="Dynamic" ErrorMessage="* A Debt ID is Required *" SetFocusOnError="true" CssClass="warningMessage" />
                            ...
                            <tr>
                                ...
                                <td align="left" width="50%"><asp:Textbox ID="txtLocationCode" runat="server" MaxLength="3" Columns="5" CssClass="formLabel" /></td>
                            </tr>                         
                            <tr>
