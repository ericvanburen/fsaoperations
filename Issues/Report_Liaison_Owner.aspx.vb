...
Partial Class Issues_Report_Liaison_Owner
    ...
    Public Sub btnExportExcel_Click(sender As Object, e As EventArgs)
        Export("Liaison_Report_Responsible_Owner" & ".xls", GridView1)
    End Sub
    ...
    Protected Sub dsGridView_Selected(sender As Object, e As SqlDataSourceStatusEventArgs)
        Dim intAffectedRows As Integer = e.AffectedRows
        If e.AffectedRows > 0 Then
            btnExportExcel.Visible = True
            btnExportWord.Visible = True
            lblRecordCount.Visible = True
            If intAffectedRows = 1 Then
                lblRecordCount.Text = intAffectedRows.ToString & " issue was found"
            Else
                lblRecordCount.Text = intAffectedRows.ToString & " issues were found"
            End If
    ...
    Protected Sub btnExportWord_Click(ByVal sender As Object, ByVal e As EventArgs)
        ...
        Response.AddHeader("content-disposition", "attachment;filename=Liaison_Report_Responsible_Owner.doc")
        Response.Charset = ""
    ...
    Sub btnSearch_Click(ByVal sender As Object, ByVal e As EventArgs)
        ...
        If ddlOwner.SelectedValue = "All" Then
            dsGridView.SelectParameters("Owner").DefaultValue = ddlOwner.SelectedValue
        Else
            Dim strSearchValue As String = ""
            Dim li As ListItem
            For Each li In ddlOwner.Items
            ...
            dsGridView.SelectParameters("Owner").DefaultValue = strSearchValue
        End If
