<%@ Page Title="Add New PCA Complaint" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="PCAComplaint_Add.aspx.vb" Inherits="Issues_PCAComplaint_Add" MaintainScrollPositionOnPostback="true" %>
...
<div class="panel panel-primary">
  <div class="panel-heading">
    <span class="panel-title">Enter New PCA Complaint</span>
  </div>
   ...
   <table style="padding: 5px 5px 5px 15px;" width="100%" cellpadding="5" cellspacing="5">
    ...
    <td align="right"><!--ComplaintSource-->       
            ...
            <td><asp:DropDownList ID="ddlComplaintSource" runat="server" CssClass="inputBox">
                 <asp:ListItem Text="Borrower" Value="B" />
                 <asp:ListItem Text="Attorney" Value="A" />
    ...
    <tr>
        ...
        <td><asp:DropDownList ID="ddlValidity" runat="server" CssClass="inputBox" AppendDataBoundItems="true">
            ...
            <asp:ListItem Text="Invalid" Value="I" />
            <asp:ListItem Text="Undetermined" Value="U" />
            <asp:ListItem Text="Valid" Value="V" />                                
        </asp:DropDownList></td>
    ...
    <tr>
        ...
        <!--DateResolved-->
        Date Resolved </td>
        <td align="left" colspan="3"><asp:TextBox ID="txtDateResolved" runat="server" CssClass="datepicker" />        
        </td>
    </tr>
</table>
  </div>
...
<div align="center">
    ...
    <asp:Button runat="server" ID="btnAddAnother" CssClass="btn btn-lg btn-success" Text="Add Another Complaint" OnClick="btnAddAnother_Click" Visible="false" /><br />
    <asp:Label runat="server" ID="lblInsertConfirm" CssClass="alert-success" />
</div>
