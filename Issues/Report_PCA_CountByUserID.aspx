<%@ Page Title="PCA Report - Count By UserID" Language="VB" MasterPageFile="~/Issues/Site.master" AutoEventWireup="true" CodeFile="Report_PCA_CountByUserID.aspx.vb" Inherits="Issues_Report_PCA_CountByUserID" %>
...
<!--Chart Datasource for Total Complaints By UserID-->
<asp:SqlDataSource ID="dsChartCountByUserID" runat="server" SelectCommand="p_Chart_PCA_CountByUserID"
SelectCommandType="StoredProcedure" ConnectionString="<%$ ConnectionStrings:IssuesConnectionString %>" />

<!--Datasource for Total Complaints By UserID-->
<asp:SqlDataSource ID="dsReportCountByUserID" runat="server" SelectCommand="p_Report_PCA_CountByUserID"
SelectCommandType="StoredProcedure" ConnectionString="<%$ ConnectionStrings:IssuesConnectionString %>" /> 

<br />
<div class="panel panel-primary">
  <div class="panel-heading">
    <span class="panel-title">Total PCA Issues Assigned to Loan Analysts</span>
  </div>
  <div class="panel-body" align="center">
 <asp:Chart ID="chtPCAIssuesAssignedLoanAnalysts" runat="server" BackColor="#D3DFF0" Width="900px" Height="350px" DataSourceID="dsChartCountByUserID"
        ...
        <Titles>
            <asp:Title ShadowColor="32, 0, 0, 0" Font="Trebuchet MS, 14.25pt, style=Bold" ShadowOffset="3"
                Text="PCA Issues Assigned to Loan Analysts" ForeColor="26, 59, 105">
            </asp:Title>
        </Titles>
        <Legends>
