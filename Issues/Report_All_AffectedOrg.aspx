<%@ Page Title="All Issues - Count By Affected Org" Language="VB" MasterPageFile="~/Issues/Site.master" AutoEventWireup="false" CodeFile="Report_All_AffectedOrg.aspx.vb" Inherits="Issues_Report_All_AffectedOrg" %>
...
<asp:SqlDataSource ID="dsChartReportCompletedPendingByAffectedOrg" runat="server" SelectCommand="p_Chart_All_ReportCompletedPendingByAffectedOrg"
...
<asp:SqlDataSource ID="dsReportReportCompletedPendingByAffectedOrg" runat="server" SelectCommand="p_Report_All_ReportCompletedPendingByAffectedOrg"
SelectCommandType="StoredProcedure" ConnectionString="<%$ ConnectionStrings:IssuesConnectionString %>" />
...
<div class="panel panel-primary">
  <div class="panel-heading">
    <span class="panel-title">All Issues By Affected Org</span>
  </div>
  <div class="panel-body" align="center">
 
    <asp:Chart ID="Chart2" runat="server" BackColor="#D3DFF0" Width="900px" Height="500px" DataSourceID="dsChartReportCompletedPendingByAffectedOrg" 
        ...
        <Titles>
            <asp:Title ShadowColor="32, 0, 0, 0" Font="Trebuchet MS, 14.25pt, style=Bold" ShadowOffset="3"
                Text="All Issues By Affected Org" ForeColor="26, 59, 105">
            </asp:Title>
        </Titles>
        <Legends>
 ...
 <br /><br />
 <asp:GridView ID="GridView2" runat="server" DataSourceID="dsReportReportCompletedPendingByAffectedOrg" AllowSorting="true"
