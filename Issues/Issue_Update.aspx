  ...
  <div class="panel-body" id="pnlLiaisonIssuesBody">
   <table style="padding: 5px 5px 5px 15px;" width="100%" cellpadding="5" cellspacing="5">
    ...
    <tr>
           ...
           <td align="left"><asp:DropDownList ID="ddlAffectFFEL" runat="server" SelectedValue='<%# Eval("AffectFFEL")%>'>
                <asp:ListItem Text="" Value="" />
                <asp:ListItem Text="Yes" Value="Yes" />
                <asp:ListItem Text="No" Value="No" />
            </asp:DropDownList></td>
        <td align="right"><a href="#" data-toggle="popover" title="SME Topic" data-content="The SME for this topic">SME Topic</a></td>
           <td align="left"><asp:DropDownList ID="ddlSMETopic" runat="server" SelectedValue='<%# Eval("SMETopic")%>'>
               <asp:ListItem Text="" Value="" />
