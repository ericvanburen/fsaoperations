...
Partial Class Issues_Report_Liaison_OpenRecentlyClosed
    ...
    Public Sub btnExportExcel_Click(sender As Object, e As EventArgs)
        Export("Liaison_Report_Open_Recently_Closed_Issues" & ".xls", GridView1)
    End Sub
    ...
    Protected Sub btnExportWord_Click(ByVal sender As Object, ByVal e As EventArgs)
        ...
        'Response.AddHeader("content-disposition", "attachment;filename=Liaison_Report_Open_Recently_Closed_Issues.doc")
        'Response.Charset = ""
