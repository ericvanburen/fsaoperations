<%@ Page Title="Liaison Report - Count by User" Language="VB" MasterPageFile="~/Issues/Site.master" AutoEventWireup="false" CodeFile="Report_LiaisonCountByUserID.aspx.vb" Inherits="Issues_Report_LiaisonCountByUserID" %>
...
<!--Chart Datasource for Total Issues By UserID-->
<asp:SqlDataSource ID="dsChartCountByUserID" runat="server" SelectCommand="p_Chart_Liaison_CountByUserID"
SelectCommandType="StoredProcedure" ConnectionString="<%$ ConnectionStrings:IssuesConnectionString %>" />

<!--Datasource for Total Issues By UserID-->
<asp:SqlDataSource ID="dsReportCountByUserID" runat="server" SelectCommand="p_Report_Liaison_CountByUserID"
SelectCommandType="StoredProcedure" ConnectionString="<%$ ConnectionStrings:IssuesConnectionString %>" /> 
...
<div class="panel panel-primary">
  <div class="panel-heading">
    <span class="panel-title">Total Liaison Issues Assigned to Liaisons</span>
  </div>
  <div class="panel-body" align="center">
 <asp:Chart ID="chtLiaisonIssuesAssignedLoanAnalysts" runat="server" BackColor="#D3DFF0" Width="900px" Height="350px" DataSourceID="dsChartCountByUserID"
        ...
        <Titles>
            <asp:Title ShadowColor="32, 0, 0, 0" Font="Trebuchet MS, 14.25pt, style=Bold" ShadowOffset="3"
                Text="Liaison Issues Assigned to Liaisons" ForeColor="26, 59, 105">
            </asp:Title>
        </Titles>
        <Legends>
