...
Partial Class Issues_Report_Liaison_Assigned_Responsible_Area
    ...
    Protected Sub ddlResponsibleArea_SelectedIndexChanged(sender As Object, e As System.EventArgs) Handles ddlResponsibleArea.SelectedIndexChanged
        dsGridView.SelectParameters("ResponsibleArea").DefaultValue = ddlResponsibleArea.SelectedValue
        GridView1.DataBind()
    End Sub
    ...
    Public Sub btnExportExcel_Click(sender As Object, e As EventArgs)
        Export("Liaison_Report_Assigned to Responsible Area" & ".xls", GridView1)
    End Sub
    ...
    Protected Sub btnExportWord_Click(ByVal sender As Object, ByVal e As EventArgs)
        ...
        'Response.AddHeader("content-disposition", "attachment;filename=Liaison_Report_Assigned to Responsible Area.doc")
        'Response.Charset = ""
