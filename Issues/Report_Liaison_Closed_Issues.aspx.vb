...
Partial Class Issues_Report_Liaison_Core
    ...
    Public Sub btnExportExcel_Click(sender As Object, e As EventArgs)
        Export("Liaison_Team_Closed_Issues_Report" & ".xls", GridView1)
    End Sub
    ...
    Protected Sub btnSearch_Click(sender As Object, e As System.EventArgs)
        dsGridView.SelectParameters("DateReceived").DefaultValue = txtDateReceived.Text
        dsGridView.SelectParameters("DateResolved").DefaultValue = txtDateResolved.Text
        GridView1.DataBind()
    ...
    Protected Sub btnExportWord_Click(ByVal sender As Object, ByVal e As EventArgs)
        ...
        Response.AddHeader("content-disposition", "attachment;filename=Liaison_Team_Closed_Issues_Report.doc")
        Response.Charset = ""
