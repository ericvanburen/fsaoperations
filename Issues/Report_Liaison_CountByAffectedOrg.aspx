<%@ Page Title="Liaison Report - Count By Affected Org" Language="VB" MasterPageFile="~/Issues/Site.master" AutoEventWireup="false" CodeFile="Report_Liaison_CountByAffectedOrg.aspx.vb" Inherits="Issues_Report_Liaison_CountByAffectedOrg" %>
...
<!--Chart Datasource for Total Issues By Affected Org -->
<asp:SqlDataSource ID="dsChartLiaisonReportCompletedPendingBAffectedOrg" runat="server" SelectCommand="p_Chart_Liaison_ReportCompletedPendingByAffectedOrg"
SelectCommandType="StoredProcedure" ConnectionString="<%$ ConnectionStrings:IssuesConnectionString %>" />

<!--Datasource for Total Issues By Affected Org -->
<asp:SqlDataSource ID="dsReportLiaisonReportCompletedPendingByAffectedOrg" runat="server" SelectCommand="p_Report_Liaison_ReportCompletedPendingByAffectedOrg"
SelectCommandType="StoredProcedure" ConnectionString="<%$ ConnectionStrings:IssuesConnectionString %>" />
...
<div class="panel panel-primary">
  <div class="panel-heading">
    <span class="panel-title">Total Liaison Issues By Affected Org</span>
  </div>
  <div class="panel-body" align="center">
 
    <asp:Chart ID="Chart2" runat="server" BackColor="#D3DFF0" Width="900px" Height="350px" DataSourceID="dsChartLiaisonReportCompletedPendingBAffectedOrg" 
        ...
        <Titles>
            <asp:Title ShadowColor="32, 0, 0, 0" Font="Trebuchet MS, 14.25pt, style=Bold" ShadowOffset="3"
                Text="Liaison Issues By Affected Org" ForeColor="26, 59, 105">
            </asp:Title>
        </Titles>
        <Legends>
 ...
 <br /><br />
 <asp:GridView ID="GridView2" runat="server" DataSourceID="dsReportLiaisonReportCompletedPendingByAffectedOrg" AllowSorting="true"
        AutoGenerateColumns="false" CssClass="table table-hover table-striped">
       <Columns>
            <asp:BoundField DataField="AffectedOrg" HeaderText="AffectedOrg" SortExpression="AffectedOrg"
