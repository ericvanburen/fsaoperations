<%@ Page Title="Liaison Report - Issue Assignment" Language="VB" MasterPageFile="Site.master" AutoEventWireup="false" CodeFile="Report_Liaison_Owner.aspx.vb" Inherits="Issues_Report_Liaison_Owner" EnableEventValidation="false" %>
...
<h4>Liaison Report - Issue Assignment</h4>

Open Issues That Were Opened Greater Than   
    <asp:DropDownList ID="ddlDays" runat="server" CssClass="input">
    ...
    </asp:DropDownList> Days Ago  and the Issue Is Assigned To 
    <asp:ListBox ID="ddlOwner" runat="server" CssClass="inputBox" DataSourceID="dsOwners" SelectionMode="Multiple" DataTextField="Owner" DataValueField="Owner" AppendDataBoundItems="true">
...
<asp:SqlDataSource ID="dsGridView" runat="server" SelectCommand="p_Report_Liaison_Owner" OnSelected="dsGridView_Selected"
...
<SelectParameters>
    ...
    <asp:Parameter Name="Owner" Type="String" DefaultValue="All" />
</SelectParameters>
</asp:SqlDataSource>

<!--Datasource for the owners dropdownlist-->
<asp:SqlDataSource ID="dsOwners" runat="server" SelectCommand="p_Owners"    
  SelectCommandType="StoredProcedure" ConnectionString="<%$ ConnectionStrings:IssuesConnectionString %>">      
</asp:SqlDataSource>

<p />

<asp:Label ID="lblRecordCount" runat="server" CssClass="alert-success" />
<asp:GridView ID="GridView1" runat="server" DataSourceID="dsGridView" AllowSorting="true" Caption="Liaison Report - Issue Assignment" RowStyle-VerticalAlign="Top" 
        ...
        <Columns>          
            ...
            <asp:TemplateField HeaderText="Comments" ItemStyle-CssClass="hidden" HeaderStyle-CssClass="hidden"> 
             <ItemTemplate>
             ...
             <asp:BoundField DataField="DateResolved" HeaderText="Date Resolved" HeaderStyle-HorizontalAlign="Center" />
        </Columns>
