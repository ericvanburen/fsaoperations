<%@ Page Title="" Language="VB" MasterPageFile="Site.master" AutoEventWireup="false" CodeFile="Report_Liaison_OpenRecentlyClosed.aspx.vb" Inherits="Issues_Report_Liaison_OpenRecentlyClosed" EnableEventValidation="false" %>
...
<h3>Liaison Report - Open and Recently Closed Issues</h3> 
<h5>(Open, Deferred, Agenda OR Closed Within Last  
    ...
    </asp:DropDownList> Days)</h5>

<!--Datasource for the Gridview-->
<asp:SqlDataSource ID="dsGridView" runat="server" SelectCommand="p_Report_Liaison_OpenRecentlyClosed"
...
<SelectParameters>
 ...
 <asp:GridView ID="GridView1" runat="server" DataSourceID="dsGridView" AllowSorting="true" RowStyle-VerticalAlign="Top" Width="100%"
     ...
     <RowStyle Font-Names="Calibri" Font-Size="10.5pt" Wrap="true" />
     <HeaderStyle Font-Names="Calibri" Font-Size="11pt" />
</asp:GridView>

<div align="center">
    <asp:Button ID="hp1" runat="server" CausesValidation="false" OnClick="btnExportExcel_Click" CssClass="btn btn-md btn-danger" Text="Download to Excel" />
    <asp:Button ID="btnExportWord" runat="server" CausesValidation="false" OnClick="btnExportWord_Click" CssClass="btn btn-md btn-alert" Text="Download to Word" />
</div>
</asp:Content>
