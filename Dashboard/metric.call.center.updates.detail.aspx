...
<script runat="server">
    ...
    Protected Sub DetailsView1_ItemUpdating(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DetailsViewUpdateEventArgs) 'Handles DetailsView1.ItemUpdating
        dsMetricStatusUpdateCallCenter.UpdateParameters("NoAssigned").DefaultValue = DirectCast(DetailsView1.FindControl("txtNoAssigned"), TextBox).Text
        dsMetricStatusUpdateCallCenter.UpdateParameters("NoMonitored").DefaultValue = DirectCast(DetailsView1.FindControl("txtNoMonitored"), TextBox).Text
        dsMetricStatusUpdateCallCenter.UpdateParameters("PassFail").DefaultValue = DirectCast(DetailsView1.FindControl("ddlPassFail"), DropDownList).SelectedValue
        dsMetricStatusUpdateCallCenter.UpdateParameters("WeekEndingID").DefaultValue = DirectCast(DetailsView1.FindControl("ddlWeekEnding"), DropDownList).SelectedValue
        dsMetricStatusUpdateCallCenter.UpdateParameters("StatusID").DefaultValue = DirectCast(DetailsView1.FindControl("ddlStatus"), DropDownList).SelectedValue
        dsMetricStatusUpdateCallCenter.UpdateParameters("Comments").DefaultValue = DirectCast(DetailsView1.FindControl("txtComments"), TextBox).Text
        dsMetricStatusUpdateCallCenter.UpdateParameters("ServiceDirectorComments").DefaultValue = DirectCast(DetailsView1.FindControl("txtServiceDirectorComments"), TextBox).Text
    End Sub
    
    Sub BindRecord()
        dsMetricStatusUpdateCallCenter.SelectParameters.Item("MetricUpdateID").DefaultValue = lblMetricUpdateID.Text
    End Sub
...
<body>
    ...
    <fieldset class="fieldset">
		                 ...
		                 <img src="images/fSA_logo_dashboard.gif" alt="Federal Student Aid - Dashboard Reports" />                        
                           ...
                           <div id="menu" align="center" style="padding-right: 21px; padding-top: 5px; color: Blue; font-size: small">
                            ...
                            <br /><br /><br />
                                    ...
                                    <div id="Div1">                                   
                                    <asp:SqlDataSource ID="dsMetricStatusUpdateCallCenter" runat="server" 
                                        ConnectionString="<%$ ConnectionStrings:DashboardConnectionString %>" 
                                        SelectCommand="p_MetricStatusSelectCallCenter" SelectCommandType="StoredProcedure"
                                        UpdateCommand="p_MetricStatusUpdateCallCenter" UpdateCommandType="StoredProcedure">
                                        <SelectParameters>
                                            <asp:Parameter Name="MetricUpdateID" />
                                        </SelectParameters>
                                        <UpdateParameters>
                                            <asp:Parameter Name="MetricUpdateID" Type="Int32" />
                                            <asp:Parameter Name="NoAssigned" Type="Int32" />
                                            <asp:Parameter Name="NoMonitored" Type="Int32" />
	                                        <asp:Parameter Name="PassFail" Type="String" />
     ...
     AutoGenerateEditButton="True" DataSourceID="dsMetricStatusUpdateCallCenter" DefaultMode="Edit"
     DataKeyNames="MetricUpdateID" OnItemUpdating="DetailsView1_ItemUpdating" OnItemUpdated="DetailsView1_ItemUpdated" 
        ...
        <AlternatingRowStyle BackColor="White" ForeColor="#284775" />         
         <Fields>
            ...
            <ItemTemplate>
                <asp:DropDownList ID="ddlWeekEnding" runat="server" DataSourceID="dsWeekEnding" Width="150px" 
            ...
            <asp:TemplateField HeaderText="Number Assigned" HeaderStyle-HorizontalAlign="Right">
            <ItemTemplate>
              <asp:TextBox id="txtNoAssigned" runat="server" Text='<%# Eval("NoAssigned")%>' />            
            </ItemTemplate>
            </asp:TemplateField>

            <asp:TemplateField HeaderText="Number Monitored" HeaderStyle-HorizontalAlign="Right">
            <ItemTemplate>
                 <asp:TextBox id="txtNoMonitored" runat="server" Text='<%# Eval("NoMonitored")%>' />
            </ItemTemplate>
            </asp:TemplateField>

            <asp:TemplateField HeaderText="Pass/Fail" HeaderStyle-HorizontalAlign="Right">
            <ItemTemplate>
                <asp:DropDownList ID="ddlPassFail" runat="server" SelectedValue='<%# Eval("PassFail")%>'>
