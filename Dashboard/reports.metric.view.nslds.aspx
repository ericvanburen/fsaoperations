...
<head id="Head1" runat="server">
    <title>Operation Services Dashboard Reports - NSLDS Call Center Metric Updates</title>
		                 ...
		                 <img src="images/fSA_logo_dashboard.gif" alt="Federal Student Aid - Dashboard Reports" />                        
                           ...
                           <div id="menu" align="center" style="padding-right: 21px; padding-top: 5px; color: Blue; font-size: small">
                            ...
                            <br /><br />
                                    ...
                                    <!--Populates GridView1-->
                                    <asp:SqlDataSource ID="dsNSLDSCallCenterStatus" runat="server" 
                                        ConnectionString="<%$ ConnectionStrings:DashboardConnectionString %>" 
                                        SelectCommand="p_NSLDSCallCenterStats" SelectCommandType="StoredProcedure">                                        
                                        </asp:SqlDataSource>                                    
                                    ...
                                    <div align="left" style="padding-top: 10px" id="tabs-1">                                        
                                        ...
                                        <table border="0" width="100%">
                                            <tr>
                                                <td align="left"><h2><asp:Label ID="lblPageHeader" runat="server" Text="Current Metrics Status - NSLDS Call Center" /></h2></td>                                               
                                            </tr>
                                        </table>
                                        <div class="grid">
                                        <asp:GridView id="GridView1" runat="server" DataSourceID="dsNSLDSCallCenterStatus"  
                                        ...
                                        <Columns>                       
                                            <asp:BoundField DataField="WeekEnding" HeaderText="Week Ending" runat="server" SortExpression="WeekEnding" ItemStyle-HorizontalAlign="Center" DataFormatString="{0:d}" />
                                            <asp:BoundField DataField="CallsOffered" HeaderText="Calls Offered" SortExpression="CallsOffered" ItemStyle-HorizontalAlign="Center" DataFormatString="{0:N0}" />
                                            <asp:BoundField DataField="Abandoned" HeaderText="Abandoned" SortExpression="Abandoned" ItemStyle-HorizontalAlign="Center" DataFormatString="{0:N0}" />
                                            <asp:BoundField DataField="AvgSpeedAnswer" HeaderText="Avg Speed Answer" SortExpression="AvgSpeedAnswer" ItemStyle-HorizontalAlign="Center" DataFormatString="{0:N0}" />
                                            <asp:BoundField DataField="Username" HeaderText="Entered By" SortExpression="Username" ItemStyle-HorizontalAlign="Center" />                            
                                        </Columns>
                                        </asp:GridView>
                                        </div>
                                        <br />
