...
<script runat="server">
   Public Overloads Overrides Sub VerifyRenderingInServerForm(ByVal control As Control) 
    ...
    Private Sub btnExportExcel_Click()
        ...
        Response.Clear()
        Response.AddHeader("content-disposition", "attachment;filename=DashboardCommentsReport.xls")
        Response.Charset = ""
    ...
    Public Shared Function WrappableText(ByVal source As String) As String
        ...
        Return "<p>" + source.Replace(newLine + newLine, "</p><p>").Replace(newLine, "<br/>") + "</p>"
    End Function
                            ...
                            <br /><br />
                               ...
                               <div id="Div1">   
                                    ...
                                    <asp:SqlDataSource ID="dsComments" runat="server" 
                                        ...
                                        SelectCommand="p_Comments" SelectCommandType="StoredProcedure">                                                                             
                                        </asp:SqlDataSource>
                                    ...
                                    <div align="left" style="padding-top: 10px" id="tabs-1">                                       
                                        ...
                                        <table border="0" width="100%">
                                            <tr>
                                                <td align="left"><h2><asp:Label ID="lblPageHeader" runat="server" Text="Comments" /></h2></td>
                                                                                          
                                            </tr>
                                        </table>
                                        <div class="grid">
                                        <asp:GridView id="GridView1" runat="server" DataSourceID="dsComments" 
                                         ...
                                         AllowSorting="true" DataKeyNames="CommentID">
                                        ...
                                        <Columns>                                    
                                            ...
                                            <asp:TemplateField HeaderText="Comments">
                                                <ItemTemplate>
                                                    <asp:Label Text='<%# WrappableText(Container.DataItem("Comments"))%>' runat="server" /> 
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                           <asp:BoundField DataField="Username" HeaderText="Entered By" runat="server" />
                                            <asp:BoundField DataField="DateEntered" HeaderText="Date Entered" runat="server" DataFormatString="{0:d}" SortExpression="Date Entered" ItemStyle-HorizontalAlign="Center" />                                           
                                        </Columns>
                                        </asp:GridView>
                                        </div>
