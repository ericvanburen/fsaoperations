...
<script runat="server">
    ...
    Sub btnSubmit_Click(ByVal sender As Object, ByVal e As EventArgs)
        ...
        cmd = New SqlCommand("p_CommentAdd", strSQLConn)
        ...
        Try
            ...
            cmd.ExecuteNonQuery()
            lblRecordStatus.Text = "Your comment was successfully added"
...
<head id="Head1" runat="server">
    <title>Operation Services Dashboard Reports - Submit New Comment</title>
              ...
              <tr>
                    <td align="left">
		                 <img src="images/fSA_logo_dashboard.gif" alt="Federal Student Aid - Dashboard Reports" />                        
                            <div id="tabs">
                            <ul>
                                <li><a href="#tabs-1">Add New Comment</a></li>                                
                            </ul>
                            ...
                            <br /><br />
                                 <div id="Div1">   
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtComments" runat="server" Height="200px" TextMode="MultiLine" 
                                                Width="544px"></asp:TextBox><br />
                                            <asp:RequiredFieldValidator ID="rfComments" runat="server" ControlToValidate="txtComments" Display="Dynamic" CssClass="warning" ErrorMessage="* Please enter your comments * " />
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td class="style1">&nbsp;</td>
                                        <td align="center">
                                            <asp:Button ID="btnSubmit" runat="server" Text="Submit Comment" CssClass="button" OnClick="btnSubmit_Click" />
