                                        ...
                                        Width="95%" HorizontalAlign="Center" CssClass="datatable" BorderStyle="Solid" BorderWidth="2px" BackColor="White" GridLines="Horizontal" AllowPaging="true" AllowSorting="true">
                                            ...
                                            <Columns>
                                               ...
                                               <asp:TemplateField HeaderText="Week Ending" HeaderStyle-HorizontalAlign="Center" SortExpression="WeekEnding">
                                                <ItemTemplate>
                                                    <a href='metric.updates.detail.aspx?MetricUpdateID=<%# Eval("MetricUpdateID")%>'><%# Eval("WeekEnding", "{0:d}")%></a>
                                                     <asp:Label ID="lblServiceDirectorComments" runat="server" Text='<%# ServiceDirectorComments(Eval("ServiceDirectorComments"))%>' CssClass="warning" />
                                                </ItemTemplate>
                                                </asp:TemplateField>
