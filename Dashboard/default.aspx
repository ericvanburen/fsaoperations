...
<script runat="server">
    Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs)
        If Not Page.IsPostBack Then
            ...
            If Not Request.Cookies("Dashboard") Is Nothing Then
                txtUsername.Text = Request.Cookies("Dashboard")("Username").ToString()
                
                Dim strPassword As String
                strPassword = Request.Cookies("Dashboard")("Password").ToString()
            ...
            Using con
                ...
                If dr.Read() Then
                    ...
                    If chkRememberMe.Checked Then
                        ...
                        Response.Cookies("Dashboard")("Username") = txtUsername.Text.ToString()
                        Response.Cookies("Dashboard")("Password") = txtPassword.Text.ToString()
                        Response.Cookies("Dashboard")("UserID") = dr("UserID")
                        'Cookie expires in 30 days
                        Response.Cookies("Dashboard").Expires = DateTime.Now.AddDays(30)
                    End If
                    
                    Response.Redirect("my.projects.aspx")
                Else
                    'Login failed
...
<head id="Head1" runat="server">
    <title>Dashboard Reports Login</title>
...
<body>
    ...
    <div align="center">
            <table border="0" width="900px">
              <tr>
                    <td align="left">
		               <img src="images/fsa_logo_dashboard.gif" />
                            ...
                            <ContentTemplate>
                                ...
                                <asp:UpdateProgress runat="server" ID="PageUpdateProgress" AssociatedUpdatePanelID="pnlUpdate1"
                                    DynamicLayout="true">
                                    <ProgressTemplate>
                                        <img src="images/ajax-loader.gif" alt="logging in" /> Please wait while you are signed in
                                    </ProgressTemplate>
                                </asp:UpdateProgress>
                                </div>
