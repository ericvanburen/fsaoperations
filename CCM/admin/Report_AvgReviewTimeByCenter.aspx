<%@ Page Title="Call Center Monitoring - Average Review Time By Call Center" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Report_AvgReviewTimeByCenter.aspx.vb" Inherits="CCM_admin_Report_AvgReviewTimeByCenter" %>
    ...
    <fieldset class="fieldset">
        <div align="center">
            <table border="0" width="900px">
                <tr>
                    <td align="left">
                        <h2>Call Center Monitoring - Average Review Time By Call Center</h2>
                        <div id="tabs">
                                ...
                                <ul id="nav">
                                    ...
                                    <li><a href="#">Administration</a>
                                        <ul>                                           
                                            ...
                                            <li><a href="Report_AvgReviewTimeByCenter.aspx">Avg Review Time By Call Center</a></li>
                                            <li><a href="Search.aspx">Search</a></li>
                                        </ul>
                                    </li>
                            ...
                            <div id="Div1">
                                ...
                                <div align="left" style="padding-top: 10px" id="tabs-1">
                                    <table cellpadding="2" cellspacing="2" border="0" width="100%">
                                        <tr>
                                            ...
                                            <td valign="bottom">
                                                <asp:Button ID="btnSearch" runat="server" CssClass="button" Text="Search" OnClick="btnReportAvgReviewTime_Click"
                                        ...
                                        <table border="0" width="100%">
                                            <tr>
                                                ...
                                                <td align="center" width="33%">
                                                    <asp:Label ID="lblRowCountReviewTime" runat="server" CssClass="warning" />
                                                </td>
                                                <td align="right" width="33%">
                                                    <asp:ImageButton ID="btnExportExcel" runat="server" CausesValidation="false" ImageUrl="../images/btnExportExcel.gif"
                                                        OnClick="btnExportExcel_AvgReviewTime_Click" CssClass="btnExportExcel" />
                                                </td>
                                            </tr>
                                        </table>
                                    </asp:Panel>
                                ...
                                <div id="divVariablePeriod" class="grid" align="center">
                                    <asp:GridView ID="grdReviewTime" runat="server" AutoGenerateColumns="false" AllowSorting="false"
                                        ...
                                        <Columns>
                                            <asp:BoundField DataField="UserID" HeaderText="Reviewer" ItemStyle-HorizontalAlign="Left"
                                                HeaderStyle-HorizontalAlign="Left" />
                                            <asp:BoundField DataField="CallCenter" HeaderText="Call Center" ItemStyle-HorizontalAlign="Left"
                                                HeaderStyle-HorizontalAlign="Left" />
                                            <asp:BoundField DataField="AvgReviewTime" HeaderText="Avg Review Time" ItemStyle-HorizontalAlign="Left"
                                                HeaderStyle-HorizontalAlign="Left" />
                                        </Columns>
