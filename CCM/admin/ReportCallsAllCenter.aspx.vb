...
Partial Class CCM_New_ReportFailedCalls
    ...
    Sub btnCallsSummary_Click(ByVal sender As Object, ByVal e As EventArgs)
        BindGridView_CallsSummary()
    End Sub

    Sub BindGridView_CallsSummary()
        Dim strSQLConn As SqlConnection
        Dim cmd As SqlCommand
        Dim ds As DataSet

        strSQLConn = New SqlConnection(ConfigurationManager.ConnectionStrings("CCMConnectionString").ConnectionString)
        cmd = New SqlCommand("p_Report_CallsSummary_AllCallCenters", strSQLConn)
        cmd.CommandType = CommandType.StoredProcedure
        cmd.Parameters.Add("@BeginDateofReview", SqlDbType.VarChar).Value = txtDateofReviewBeginFailedCalls.Text
        cmd.Parameters.Add("@EndDateofReview", SqlDbType.VarChar).Value = txtDateofReviewEndFailedCalls.Text
    ...
    Public Sub btnExportExcel_CallsSummary_Click(sender As Object, e As System.Web.UI.ImageClickEventArgs)
        Export("CallsSummary.xls", GridView1)
    End Sub
