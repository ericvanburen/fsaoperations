...
Partial Class PCAReviews_MyNewAssignments
    ...
    Protected Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles GridView1.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            Dim strReviewPeriod As String = e.Row.Cells(2).Text
            Dim strReviewPeriodMonth As String = Left(e.Row.Cells(2).Text, 2)
            Dim strReviewPeriodYear As String = Right(e.Row.Cells(2).Text, 4)
            ...
            link2.Text = "Show Reviews"
            link2.NavigateUrl = "MyCallReviews.aspx?PCA=" & Server.UrlEncode(strPCA) & "&PCAID=" & strPCAID & "&ReviewPeriod=" & Server.UrlEncode(strReviewPeriod) & "&NewAssignmentID=" & strNewAssignmentID
