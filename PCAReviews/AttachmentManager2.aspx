<%@ Page Title="PCA Reviews - Attachment Manager" Language="VB" AutoEventWireup="true" CodeFile="AttachmentManager2.aspx.vb" Inherits="PCACalls_AttachmentManager" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>PCA Reviews - Attachment Manager</title>
...
<asp:Label ID="lblSavedReviewID" runat="server" Visible="false" />
</form>
</body>
</html>
