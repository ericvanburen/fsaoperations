...
Partial Class PCAReviews_Report_Summary
    ...
    Sub btnSearch_Click(sender As Object, e As EventArgs)
        ...
        'Rehab - Must Not Say
        lblScore_Delay_Tax_Reform_Total.Text = "0"
        lblScore_Delay_Tax_Reform_Incorrect.Text = "0"
        lblScore_Delay_Tax_Reform_Percent.Text = "0"

        lblScore_More_Aid_Total.Text = "0"
        lblScore_More_Aid_Incorrect.Text = "0"
        lblScore_More_Aid_Percent.Text = "0"

        lblScore_Collection_Costs_Waived_Total.Text = "0"
        lblScore_Collection_Costs_Waived_Incorrect.Text = "0"
        lblScore_Collection_Costs_Waived_Percent.Text = "0"

        lblScore_False_Requirements_Total.Text = "0"
        lblScore_False_Requirements_Incorrect.Text = "0"
        lblScore_False_Requirements_Percent.Text = "0"

        lblScore_Avoid_PIF_Total.Text = "0"
        lblScore_Avoid_PIF_Incorrect.Text = "0"
        lblScore_Avoid_PIF_Percent.Text = "0"

        lblScore_Rehab_Then_TPD_Total.Text = "0"
        lblScore_Rehab_Then_TPD_Incorrect.Text = "0"
        lblScore_Rehab_Then_TPD_Percent.Text = "0"

        lblScore_Payments_Are_Final_Total.Text = "0"
        lblScore_Payments_Are_Final_Incorrect.Text = "0"
        lblScore_Payments_Are_Final_Percent.Text = "0"

        lblScore_Not_Factual_Total.Text = "0"
        lblScore_Not_Factual_Incorrect.Text = "0"
        lblScore_Not_Factual_Percent.Text = "0"
    ...
    Sub btnSaveReview_Click(ByVal sender As Object, ByVal e As EventArgs)
        ...
        cmd.Parameters.Add("@Score_Delay_Tax_Reform_Total", SqlDbType.VarChar).Value = lblScore_Delay_Tax_Reform_Total.Text
        cmd.Parameters.Add("@Score_Delay_Tax_Reform_Incorrect", SqlDbType.VarChar).Value = lblScore_Delay_Tax_Reform_Incorrect.Text
        cmd.Parameters.Add("@Score_Delay_Tax_Reform_Percent", SqlDbType.VarChar).Value = lblScore_Delay_Tax_Reform_Percent.Text

        cmd.Parameters.Add("@Score_More_Aid_Total", SqlDbType.VarChar).Value = lblScore_More_Aid_Total.Text
        cmd.Parameters.Add("@Score_More_Aid_Incorrect", SqlDbType.VarChar).Value = lblScore_More_Aid_Incorrect.Text
        cmd.Parameters.Add("@Score_More_Aid_Percent", SqlDbType.VarChar).Value = lblScore_More_Aid_Percent.Text

        cmd.Parameters.Add("@Score_Collection_Costs_Waived_Total", SqlDbType.VarChar).Value = lblScore_Collection_Costs_Waived_Total.Text
        cmd.Parameters.Add("@Score_Collection_Costs_Waived_Incorrect", SqlDbType.VarChar).Value = lblScore_Collection_Costs_Waived_Incorrect.Text
        cmd.Parameters.Add("@Score_Collection_Costs_Waived_Percent", SqlDbType.VarChar).Value = lblScore_Collection_Costs_Waived_Percent.Text

        cmd.Parameters.Add("@Score_False_Requirements_Total", SqlDbType.VarChar).Value = lblScore_False_Requirements_Total.Text
        cmd.Parameters.Add("@Score_False_Requirements_Incorrect", SqlDbType.VarChar).Value = lblScore_False_Requirements_Incorrect.Text
        cmd.Parameters.Add("@Score_False_Requirements_Percent", SqlDbType.VarChar).Value = lblScore_False_Requirements_Percent.Text

        cmd.Parameters.Add("@Score_Avoid_PIF_Total", SqlDbType.VarChar).Value = lblScore_Avoid_PIF_Total.Text
        cmd.Parameters.Add("@Score_Avoid_PIF_Incorrect", SqlDbType.VarChar).Value = lblScore_Avoid_PIF_Incorrect.Text
        cmd.Parameters.Add("@Score_Avoid_PIF_Percent", SqlDbType.VarChar).Value = lblScore_Avoid_PIF_Percent.Text

        cmd.Parameters.Add("@Score_Rehab_Then_TPD_Total", SqlDbType.VarChar).Value = lblScore_Rehab_Then_TPD_Total.Text
        cmd.Parameters.Add("@Score_Rehab_Then_TPD_Incorrect", SqlDbType.VarChar).Value = lblScore_Rehab_Then_TPD_Incorrect.Text
        cmd.Parameters.Add("@Score_Rehab_Then_TPD_Percent", SqlDbType.VarChar).Value = lblScore_Rehab_Then_TPD_Percent.Text

        cmd.Parameters.Add("@Score_Payments_Are_Final_Total", SqlDbType.VarChar).Value = lblScore_Payments_Are_Final_Total.Text
        cmd.Parameters.Add("@Score_Payments_Are_Final_Incorrect", SqlDbType.VarChar).Value = lblScore_Payments_Are_Final_Incorrect.Text
        cmd.Parameters.Add("@Score_Payments_Are_Final_Percent", SqlDbType.VarChar).Value = lblScore_Payments_Are_Final_Percent.Text

        cmd.Parameters.Add("@Score_Not_Factual_Total", SqlDbType.VarChar).Value = lblScore_Not_Factual_Total.Text
        cmd.Parameters.Add("@Score_Not_Factual_Incorrect", SqlDbType.VarChar).Value = lblScore_Not_Factual_Incorrect.Text
        cmd.Parameters.Add("@Score_Not_Factual_Percent", SqlDbType.VarChar).Value = lblScore_Not_Factual_Percent.Text
