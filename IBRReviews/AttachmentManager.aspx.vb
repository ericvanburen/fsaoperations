...
Partial Class IBRReviews_AttachmentManager
    ...
    Sub btnUploadAttachment_Click(ByVal sender As Object, ByVal e As EventArgs)
        ...
        If strFileNamePath.Length > 0 Then
            ...
            Dim Filename1Regex As New Regex("(doc|docx|xls|xlsx|pdf|zip|zipx|txt|wav|mp3)$")
            ...
            strSaveLocation = "C:\Users\ericv_000\Dropbox\fsaoperations\IBRReviews\ReviewAttachments\" & strFileNameOnly
            'strSaveLocation = "D:\DCS\fsaoperations\internal\IBRReviews\ReviewAttachments\" & strFileNameOnly
