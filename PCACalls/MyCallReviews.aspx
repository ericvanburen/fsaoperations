<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="MyCallReviews.aspx.vb" Inherits="PCACalls_MyCallReviews" %>
...
<div class="panel panel-primary">
  <div class="panel-heading">
    <span class="panel-title">My PCA Reviews For <asp:Label ID="lblPCA" runat="server" /> For Recording Date <asp:Label ID="lblRecordingDeliveryDate" runat="server" /></span>
  </div>
