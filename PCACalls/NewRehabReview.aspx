<%@ Page Title="PCA Calls - New Rehab Review" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="NewRehabReview.aspx.vb" Inherits="PCACalls_NewRehabReview" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" Runat="Server">
    ...
    <script src="../Scripts/jquery.checkAvailabilityRehab.js" type="text/javascript"></script>  
...
<div class="panel panel-primary">
  <div class="panel-heading">
    <span class="panel-title">Enter New Rehab Review</span>
  </div>
...
<asp:Label ID="lblNewAssignmentID" runat="server" Visible="true" /> 
</asp:Content>
