...
Partial Class PCACalls_Reports_SavedReports
    ...
    Protected Sub BindGridView()
        ...
        If txtDateEnteredGreaterThan.Text <> "" Then
            cmd.Parameters.Add("@DateEnteredGreaterThan", SqlDbType.SmallDateTime).Value = txtDateEnteredGreaterThan.Text
        End If

        If txtDateEnteredLessThan.Text <> "" Then
            cmd.Parameters.Add("@DateEnteredLessThan", SqlDbType.SmallDateTime).Value = txtDateEnteredLessThan.Text
        End If
