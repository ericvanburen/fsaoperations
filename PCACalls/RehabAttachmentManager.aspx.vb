...
Partial Class PCACalls_RehabAttachmentManager
    Inherits System.Web.UI.Page

    Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs)
        If Not Page.IsPostBack Then
            Dim RehabReviewID As Integer
            Dim Action As String

            If Not Request.QueryString("RehabReviewID") Is Nothing Then
                RehabReviewID = Request.QueryString("RehabReviewID")
            Else
                RehabReviewID = 0
            End If

            lblRehabReviewID.Text = RehabReviewID.ToString()
    ...
    Sub btnDeleteAttachment_Click(ByVal sender As Object, ByVal e As EventArgs)
        ...
        cmd = New SqlCommand("p_DeleteRehabAttachment", con)
        cmd.CommandType = CommandType.StoredProcedure
        cmd.Parameters.AddWithValue("@RehabReviewID", SqlDbType.VarChar).Value = lblRehabReviewID.Text
    ...
    Sub btnUploadAttachment_Click(ByVal sender As Object, ByVal e As EventArgs)
        ...
        con = New SqlConnection(ConfigurationManager.ConnectionStrings("PCACallsConnectionString").ConnectionString)
        strInsert = "p_UploadRehabAttachment"
        cmdInsert = New SqlCommand(strInsert)
        cmdInsert.CommandType = CommandType.StoredProcedure
        cmdInsert.Connection = con

        cmdInsert.Parameters.AddWithValue("@RehabReviewID", SqlDbType.VarChar).Value = lblRehabReviewID.Text
        ...
        If strFileNamePath.Length > 0 Then
            ...
            Dim Filename1Regex As New Regex("(doc|docx|xls|xlsx|pdf)$")
    ...
    Sub btnDeleteAttachmentCancel_Click(ByVal sender As Object, ByVal e As EventArgs)
        Response.Redirect("ReportsRehab.aspx")
    End Sub
