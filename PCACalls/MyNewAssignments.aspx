<%@ Page Title="My New Assignments" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="MyNewAssignments.aspx.vb" Inherits="PCACalls_MyNewAssignments" %>
        ...
        <ContentTemplate>
            ...
            <div class="panel panel-primary">
              <div class="panel-heading">
                <span class="panel-title">PCA and Rehab Reviews Assigned to Me</span>
              </div>
                      ...
                      <asp:UpdatePanel ID="UpdatePanel2" runat="server"> 
                            <ContentTemplate>
                                ...
                                <table width="100%" cellpadding="3" cellspacing="3">
                                    <tr>
                                        <td colspan="2"><h4><asp:Label ID="lblReviewType" runat="server" /> for <asp:Label ID="lblPCA" runat="server" /></h4></td>
                                    </tr>
                                    <tr>
