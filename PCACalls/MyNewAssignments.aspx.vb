...
Partial Class PCACalls_MyNewAssignments
    Inherits System.Web.UI.Page

    Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs)
        If Not Page.IsPostBack Then
            dsMyNewAssignments.SelectParameters("UserID").DefaultValue = HttpContext.Current.User.Identity.Name
    ...
    Protected Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles GridView1.RowDataBound
        ...
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            Dim strReviewType As String = e.Row.Cells(2).Text
            Dim strReviewDate As String = e.Row.Cells(3).Text
            ...
            If strReviewType = "PCA Phone Review" Then
                link.Text = "Enter New Call"
                link.NavigateUrl = "NewReview.aspx?PCAID=" & strPCAID & "&RecordingDeliveryDate=" & Server.UrlEncode(strRecordingDeliveryDate) & "&ReviewDate=" & Server.UrlEncode(strReviewDate) & "&ReportQuarter=" & strReportQuarter & "&ReportYear=" & strReportYear & "&NewAssignmentID=" & strNewAssignmentID
            ElseIf strReviewType = "Rehab Review" Then
                link.Text = "Enter New Call"
                link.NavigateUrl = "NewRehabReview.aspx?PCAID=" & strPCAID & "&RecordingDeliveryDate=" & Server.UrlEncode(strRecordingDeliveryDate) & "&ReviewDate=" & Server.UrlEncode(strReviewDate) & "&ReportQuarter=" & strReportQuarter & "&ReportYear=" & strReportYear & "&NewAssignmentID=" & strNewAssignmentID
            End If
            ...
            If strReviewType = "PCA Phone Review" Then
                ...
                link2.NavigateUrl = "MyCallReviews.aspx?PCA=" & Server.UrlEncode(strPCA) & "&PCAID=" & strPCAID & "&RecordingDeliveryDate=" & Server.UrlEncode(strRecordingDeliveryDate) & "&NewAssignmentID=" & strNewAssignmentID
            ElseIf strReviewType = "Rehab Review" Then
                link2.Text = "Review Calls"
                link2.NavigateUrl = "MyRehabCallReviews.aspx?PCA=" & Server.UrlEncode(strPCA) & "&PCAID=" & strPCAID & "&RecordingDeliveryDate=" & Server.UrlEncode(strRecordingDeliveryDate) & "&NewAssignmentID=" & strNewAssignmentID
            End If
        End If
    ...
    Protected Sub LoadModal(NewAssignmentID As Integer)
        ...
        Try
            ...
            Using con
                ...
                While dr.Read()
                    lblReviewType.Text = dr("ReviewType").ToString()
    ...
    Protected Sub btnSaveChanges_Click(sender As Object, e As EventArgs)
        ...
        cmd = New SqlCommand("p_PCAAssignment_Update_LA", strSQLConn)
        cmd.CommandType = CommandType.StoredProcedure
