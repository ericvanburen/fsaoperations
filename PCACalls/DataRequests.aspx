<%@ Page Title="PCA Data and Sample Requests" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="DataRequests.aspx.vb" Inherits="PCACalls_DataRequests" EnableEventValidation="false" %>
    ...
    <script type="text/javascript">
        function OnSelectedChanged(sender, e) {
            if (sender.value == "All") {
                ...
                $("#MainContent_txtReportPeriodOther").addClass("hidden datepicker");
            }
        }
    </script>
</asp:Content>
...
<br />
  ...
  SelectCommandType="StoredProcedure" ConnectionString="<%$ ConnectionStrings:PCACallsConnectionString %>">
     <SelectParameters>
         <asp:Parameter Name="ReportPeriod" />
     </SelectParameters>      
</asp:SqlDataSource>
...
<asp:SqlDataSource ID="dsReportPeriods" runat="server" SelectCommand="p_DataRequestsAllReportPeriods"    
  SelectCommandType="StoredProcedure" ConnectionString="<%$ ConnectionStrings:PCACallsConnectionString %>">      
</asp:SqlDataSource>
...
<ContentTemplate>
  ...
  <div class="panel-body"> 
     ...
     <h4>Data and Sample Requests In Progress</h4>
      <asp:GridView ID="GridView1" runat="server" DataSourceID="dsDataRequests" AllowSorting="true" AllowPaging="true" PageSize="22" OnRowDataBound="GridView1_RowDataBound" OnRowCommand="GridView1_RowCommand"
     ...
     <EmptyDataTemplate>
         ...
         <asp:TemplateField SortExpression="ReportPeriod" HeaderStyle-HorizontalAlign="Center" >
             <HeaderTemplate>
                 Report Period: 
                 <asp:DropDownList ID="ddlReportPeriod" runat="server" CssClass="inputBox" AppendDataBoundItems="true" DataSourceID="dsReportPeriods" DataTextField="ReportPeriod" DataValueField="ReportPeriod" 
                     AutoPostBack="true" OnSelectedIndexChanged="ddlReportPeriod_SelectedIndexChanged">
         ...
         <asp:BoundField DataField="ReportPeriod" HeaderText="Report Period" SortExpression="ReportPeriod"
             ...
             <asp:BoundField DataField="DataReceiptDate" HeaderText="Data Request Date" SortExpression="DataReceiptDate"
             DataFormatString="{0:d}" HeaderStyle-HorizontalAlign="Center" HtmlEncode="false" ReadOnly="true" ItemStyle-HorizontalAlign="Center" />
         ...
         <asp:BoundField DataField="c_InitialTalkoff" HeaderText="No Initial Talkoff" HeaderStyle-HorizontalAlign="Center" ItemStyle-CssClass="hide" HeaderStyle-CssClass="hide" ReadOnly="true" />
                      ...
                      <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Always"> 
                            <ContentTemplate>
                                ...
                                <table width="95%" cellpadding="3" cellspacing="3">
                                    ...
                                    <tr>
                                        <td align="right"><label for="txtReportPeriod">Report Period</label></td>
                                        <td align="left"> <asp:DropDownList ID="ddlReportPeriodModal" runat="server" CssClass="inputBox" AppendDataBoundItems="true" DataSourceID="dsReportPeriods" DataTextField="ReportPeriod" DataValueField="ReportPeriod">
                                                <asp:ListItem Text="" Value="" />
                                            </asp:DropDownList></td>
                                    </tr>
                                    <tr>
                                        <td align="right"><label for="txtDataReceiptDate">Data Request Date</label></td>
                                    ...
                                    <tr>
                                        <td align="right"><label for="ddlc_InitialTalkoff">No Initial Talkoff</label></td>
                                        <td><asp:DropDownList ID="ddlc_InitialTalkoff" runat="server" CssClass="inputBox">
                                            <asp:ListItem Text="" Value="" />
                                            <asp:ListItem Text="1" Value="1" />
                                            <asp:ListItem Text="2" Value="2" />
                                            <asp:ListItem Text="3" Value="3" />
                            ...
                            <ContentTemplate>
                                <div class="container-fluid">
                                 <table width="95%" cellpadding="3" cellspacing="3">
                                    ...
                                    <tr>
                                        <td align="right"><label for="txtReportPeriod2">Report Period</label></td>
                                        <td align="left"> <asp:DropDownList ID="ddlReportPeriodModal2" runat="server" CssClass="inputBox" AppendDataBoundItems="true" DataSourceID="dsReportPeriods" 
                                            DataTextField="ReportPeriod" DataValueField="ReportPeriod" onchange="javascript:OnSelectedChanged(this,event);">
                                                <asp:ListItem Text="" Value="" />                                                                                           
                                            </asp:DropDownList>
                                            <asp:TextBox ID="txtReportPeriodOther" runat="server" CssClass="hidden datepicker" />

                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right"><label for="txtDataReceiptDate2">Data Request Date</label></td>
                                    ...
                                    <tr>
                                        <td align="right"><label for="ddlc_InitialTalkoff2">No Initial Talkoff</label></td>
                                        <td><asp:DropDownList ID="ddlc_InitialTalkoff2" runat="server" CssClass="inputBox">
                                            <asp:ListItem Text="" Value="" />
                                            <asp:ListItem Text="1" Value="1" />
                                            <asp:ListItem Text="2" Value="2" />
                                            <asp:ListItem Text="3" Value="3" />
