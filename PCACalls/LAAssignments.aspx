<%@ Page Title="Loan Analyst Assignments" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="LAAssignments.aspx.vb" Inherits="PCACalls_LAAssignments" EnableEventValidation="false" %>
...
<ContentTemplate>
  ...
  <div class="panel-body"> 
          ...
          <asp:GridView ID="GridView1" runat="server" DataSourceID="dsLAAssignments" AllowSorting="true" AllowPaging="true" PageSize="2" OnRowDataBound="GridView1_RowDataBound" OnRowCommand="GridView1_RowCommand"
...
<%--<button class="btn btn-primary btn-lg" data-toggle="modal" data-target="#myModal">Launch demo modal</button>--%>
                      ...
                      <asp:UpdatePanel ID="UpdatePanel2" runat="server"> 
                            <ContentTemplate>
                                ...
                                <table width="95%" cellpadding="3" cellspacing="3">
                                    <tr>
                                        <td colspan="2"><h4><asp:Label ID="lblReviewType2" runat="server" /> for <asp:Label ID="lblPCA2" runat="server" /></h4></td>
                                    </tr>
                                    <tr>
    ...
    SelectCommandType="StoredProcedure" ConnectionString="<%$ ConnectionStrings:PCACallsConnectionString %>">
        <SelectParameters>
            ...
            <asp:Parameter Name="PCAID" Type="Int32" />
            <asp:Parameter Name="RecordingDeliveryDate" Type="DateTime" />--%>
            <asp:Parameter Name="NewAssignmentID" Type="Int32" />
        </SelectParameters>
 </asp:SqlDataSource>

     <asp:SqlDataSource ID="dsRehabReviews" runat="server" SelectCommand="p_LARehabReviewsAssigned" OnSelected="OnSelectedHandlerRehabReviews"
    SelectCommandType="StoredProcedure" ConnectionString="<%$ ConnectionStrings:PCACallsConnectionString %>">
        <SelectParameters>
            <asp:Parameter Name="UserID" Type="String" />
            <asp:Parameter Name="PCAID" Type="Int32" />
    ...
    <div class="panel panel-primary">
        <div class="panel-heading">
            <span class="panel-title"><asp:Label id="lblReviewType" runat="server" /><asp:Label ID="lblUserID" runat="server" /><asp:Label ID="lblPCA" runat="server" /><asp:Label ID="lblRecordingDeliveryDate" runat="server" /> </span>
        </div>
  <div class="panel-body">
   <asp:Label ID="lblCallCountPCAReviews" runat="server" CssClass="text-info" />
    <asp:GridView ID="grdPCAReviews" runat="server" DataSourceID="dsPCAReviews" AllowSorting="true"
     ...
     <asp:Label ID="lblCallCountRehabReviews" runat="server" CssClass="text-info" />
     <asp:GridView ID="grdRehabReviews" runat="server" DataSourceID="dsRehabReviews" AllowSorting="true"
