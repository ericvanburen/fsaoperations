...
Partial Class PCACalls_DataRequests
    ...
    Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs)
        If Not Page.IsPostBack Then
            ...
            If Not Request.QueryString("ReportPeriod") Is Nothing Then
                strReportPeriod = Server.UrlDecode(Request.QueryString("ReportPeriod"))
            End If
    ...
    Protected Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles GridView1.RowDataBound
        ...
        If GridView1.HeaderRow IsNot Nothing Then
            Dim ddlReportPeriod As DropDownList = DirectCast(GridView1.HeaderRow.FindControl("ddlReportPeriod"), DropDownList)
            ddlReportPeriod.Items.FindByValue(ViewState("Filter").ToString()).Selected = True
        End If
    ...
    Protected Sub LoadModal(DataRequestID As Integer)
        ...
        ddlReportPeriodModal.SelectedValue = ""
        ...
        ddlc_InitialTalkoff.SelectedValue = ""
        txtComments.Text = ""
        ...
        Try
            ...
            Using con
                ...
                While dr.Read()
                    ...
                    'ReportPeriod is ordinal 1 in p_DataRequestAssignment
                    If Not dr.IsDBNull(1) Then
                        ddlReportPeriodModal.SelectedValue = dr("ReportPeriod")
                    End If
                    ...
                    'c_InitialTalkoff is ordinal 11 in p_DataRequestAssignment
                    If Not dr.IsDBNull(11) Then
                        ddlc_InitialTalkoff.SelectedValue = dr("c_InitialTalkoff")
                    End If
    ...
    Protected Sub LoadNewRequestModal(ByVal PCA As String)
        ...
        ddlReportPeriodModal2.SelectedValue = ""
        ...
        ddlc_InitialTalkoff2.SelectedValue = ""
        txtComments2.Text = ""
        ...
        '    ddlReportPeriodModal2.SelectedValue = ViewState("Filter")
        'End If
    End Sub
    ...
    Protected Sub btnSaveChanges_Click(sender As Object, e As EventArgs)
        ...
        If ddlReportPeriodModal.SelectedValue <> "" Then
            cmd.Parameters.Add("@ReportPeriod", SqlDbType.SmallDateTime).Value = ddlReportPeriodModal.SelectedValue
        Else
            cmd.Parameters.Add("@ReportPeriod", SqlDbType.SmallDateTime).Value = DBNull.Value
        End If
        ...
        If ddlc_InitialTalkoff.SelectedValue <> "" Then
            cmd.Parameters.Add("@c_InitialTalkoff", SqlDbType.Int).Value = ddlc_InitialTalkoff.SelectedValue
        Else
            cmd.Parameters.Add("@c_InitialTalkoff", SqlDbType.Int).Value = DBNull.Value
        End If
    ...
    Protected Sub btnAddRequest_Click(sender As Object, e As EventArgs)
        ...
        If txtReportPeriodOther.Text <> "" Then
            cmd.Parameters.Add("@ReportPeriod", SqlDbType.SmallDateTime).Value = txtReportPeriodOther.Text
        Else
            If ddlReportPeriodModal2.SelectedValue <> "" AndAlso ddlReportPeriodModal2.SelectedValue <> "Other" Then
                cmd.Parameters.Add("@ReportPeriod", SqlDbType.SmallDateTime).Value = ddlReportPeriodModal2.SelectedValue
            Else
                cmd.Parameters.Add("@ReportPeriod", SqlDbType.SmallDateTime).Value = DBNull.Value
            End If
        End If
        ...
        If ddlc_InitialTalkoff2.SelectedValue <> "" Then
            cmd.Parameters.Add("@c_InitialTalkoff", SqlDbType.Int).Value = ddlc_InitialTalkoff2.SelectedValue
        Else
            cmd.Parameters.Add("@c_InitialTalkoff", SqlDbType.Int).Value = DBNull.Value
        End If
    ...
    Protected Sub ddlReportPeriod_SelectedIndexChanged(sender As Object, e As EventArgs)
        Dim ddlReportPeriod As DropDownList = DirectCast(sender, DropDownList)
        ViewState("Filter") = ddlReportPeriod.SelectedValue
        Me.BindGrid()
    End Sub

    Private Sub BindGrid()
        dsDataRequests.SelectParameters("ReportPeriod").DefaultValue = ViewState("Filter")
        dsDataRequestsPending.SelectParameters("ReportPeriod").DefaultValue = ViewState("Filter")
    End Sub
