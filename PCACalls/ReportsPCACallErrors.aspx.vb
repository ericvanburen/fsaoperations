...
Partial Class PCACalls_ReportsPCACallErrors
    ...
    Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs)
        If Not Page.IsPostBack Then
            ...
            If Not Request.QueryString("UserID") Is Nothing Then
                ...
                dsPCACallsLAErrorReportList.SelectParameters("UserID").DefaultValue = strUserID
    ...
    Protected Sub ExportExcel2()
        ...
        Response.Clear()
        Response.AddHeader("content-disposition", "attachment;filename=PCACalls_Loan_Analyst_Errors_List.xls")
        Response.Charset = ""
        Response.ContentType = "application/vnd.xls"
        Dim stringWrite As System.IO.StringWriter = New System.IO.StringWriter()
        Dim htmlWrite As System.Web.UI.HtmlTextWriter = New HtmlTextWriter(stringWrite)
