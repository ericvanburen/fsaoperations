...
Partial Class CCM_admin_ReportIndividualProductivty
    Inherits System.Web.UI.Page

    Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs)
        If Not Page.IsPostBack Then
            ChtIndividualProductivty.Visible = False
    ...
    Sub BindGridView()
        ...
        cmd = New SqlCommand("p_Report_IndividualProductivty", strSQLConn)
        ...
        Try
            ...
            'Create the chart
            ChtIndividualProductivty.Visible = True
            Chart_IndividualProductivty()
    ...
    Public Sub btnExportExcel_VariablePeriod_Click(sender As Object, e As System.Web.UI.ImageClickEventArgs)
        Export("Individual_Productivity_Report_Ending_" & txtDateofReviewEnd.Text & ".xls", grdIndividualProductivty)
    End Sub
    ...
    Sub Chart_IndividualProductivty()

        Using myConnection As New SqlConnection
            myConnection.ConnectionString = ConfigurationManager.ConnectionStrings("CCM2ConnectionString").ConnectionString

            Dim cmd As New SqlCommand
            cmd.Connection = myConnection
            cmd.CommandText = "p_Report_IndividualProductivty"
            ...
            ChtIndividualProductivty.DataBindTable(myReader, "UserID")

            ChtIndividualProductivty.Series(0).IsValueShownAsLabel = True
