<%@ Page Title="Call Center Monitoring - Call Center Count" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="ReportCallsMonitored.aspx.vb" Inherits="CCM_New_ReportCallsMonitored" %>
    ...
    <fieldset class="fieldset">
        <div align="center">
            <table border="0" width="900px">
                <tr>
                    <td align="left">
                        <h2>Call Center Monitoring - Call Center Count</h2>
                        <div id="tabs">
                                ...
                                <div align="left" style="padding-top: 10px" id="tabs-1">
                                    <table cellpadding="2" cellspacing="2" border="0" width="100%">
                                        <tr>
                                            ...
                                            <td valign="bottom">
                                                <asp:Button ID="btnSearch" runat="server" CssClass="button" Text="Search" OnClick="btnReportVariablePeriod_Click"
                                    ...
                                    <asp:Chart ID="ChtCallCount_AllCenters" runat="server" Width="800px" Height="450px"
                                        ...
                                        <Titles>
                                            <asp:Title ShadowColor="32, 0, 0, 0" Font="Trebuchet MS, 14.25pt, style=Bold" ShadowOffset="3"
                                                Text="Call Center Count" ForeColor="26, 59, 105">
                                            </asp:Title>
                                        </Titles>
                                        <Legends>
