<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="MyProductivityReport.aspx.vb" Inherits="CCM_MyProductivityReport" %>
...
<fieldset class="fieldset">
        <div align="center">
            <table border="0" width="900px">
                <tr>
                    <td align="left">
                        <h2>Call Center Monitoring - My Productivity Report</h2>
                        <div id="tabs">
                                        ...
                                        <Columns>
                                            <asp:BoundField DataField="UserID" HeaderText="User" ItemStyle-HorizontalAlign="Left"
                                             ...
                                             <asp:BoundField DataField="CallCenter" HeaderText="Call Center" ItemStyle-HorizontalAlign="Left"
                                                HeaderStyle-HorizontalAlign="Left" />
                                            <asp:BoundField DataField="CallCount" HeaderText="Call Count" ItemStyle-HorizontalAlign="Left"
                                                HeaderStyle-HorizontalAlign="Left" />
                                        </Columns>
