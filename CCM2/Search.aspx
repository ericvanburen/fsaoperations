<%@ Page Title="Call Center Monitoring - Basic Search" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Search.aspx.vb" Inherits="CCM_New_Search" %>
    ...
    <fieldset class="fieldset">
        <div align="center">
            <table border="0" width="900px">
                <tr>
                    <td align="left">
                        <h2>Call Center Monitoring - Basic Search</h2>
                        <div id="tabs">
                                ...
                                <div align="left" style="padding-top: 10px" id="tabs-1">
                                    <table width="100%" cellpadding="4" cellspacing="5" border="0">
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2"><strong><asp:Label ID="lblEscalated" runat="server" Text="Escalated Call?" /></strong> <br />
