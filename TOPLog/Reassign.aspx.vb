...
Partial Class TOPLog_Reassign
    ...
    Sub btnAssignTOPLogs_Click(ByVal sender As Object, ByVal e As EventArgs)
            ...
            For Each gvRow As GridViewRow In grdTOPLogQueue.Rows
                ...
                If gvRow.RowType = DataControlRowType.DataRow Then
                    ...
                    If checkedRowsList.Contains(rowIndex) Then
                        ...
                        dsAssignments.UpdateParameters("UserID").DefaultValue = ddlUserID.SelectedValue
        ...
        lblAssignStatus.Text = "You successfully reassigned the TOP records to " & ddlUserID.SelectedValue
