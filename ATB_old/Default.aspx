    ...
    Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs)
        If Not Page.IsPostBack Then
            ...
            If Not Request.Cookies("ATB") Is Nothing Then
                txtUsername.Text = Request.Cookies("ATB")("Username").ToString()
            End If
            If Not Request.Cookies("ATB") Is Nothing Then
                Dim strPassword As String
                strPassword = Request.Cookies("ATB")("Password").ToString()
            ...
            Using con
                ...
                If dr.Read() Then
                    ...
                    If chkRememberMe.Checked Then
                        ...
                        Response.Cookies("ATB")("Username") = txtUsername.Text.ToString()
                        Response.Cookies("ATB")("Password") = txtPassword.Text.ToString()
                        Response.Cookies("ATB")("Admin") = dr("Admin")
                        'Cookie expires in 1 year
                        Response.Cookies("ATB").Expires = DateTime.Now.AddDays(365)
                    End If
...
<head id="Head1" runat="server">
    <title>Ability to Benefit (ATB) Login</title>
