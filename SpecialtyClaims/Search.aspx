<%@ Page Title="Specialty Claims - Account Search" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Search.aspx.vb" Inherits="DMCSRefunds_MyRefunds" EnableEventValidation="false" %>
    ...
    <script type="text/javascript">
        $(function () {
            $("#MainContent_btnUpdate").click(function () {
                ...
                $("#MainContent_lblUpdateConfirm").val("new value of textbox");
            });
        });
    </script>
...
<div>
 <ul class="nav nav-tabs">
  ...
  <li class="active"><a href="Search.aspx">Search/Update By Account</a></li>
...
<br />
 <div class="col-md-12-backgroundcolor">
    ...
    <asp:Button runat="server" ID="btnSearch" OnClick="btnSearch_Click" Text="Find Account" CssClass="btn btn-primary" ValidationGroup="1" /><br />
<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="* Account is a required field *" Display="Dynamic" ControlToValidate="txtAccountNo" CssClass="alert-danger" ValidationGroup="1" />
</div>
<br />
        ...
        <tr>
            ...
            <td colspan="2">
                ...
                <asp:TextBox ID="txtComments" runat="server" Columns="75" Rows="9" 
                    TextMode="MultiLine" CausesValidation="true" />
            </td>
        </tr>
        <tr>
            <td>&nbsp;</td>
            <td colspan="2" align="center">
                ...
                <br />
                <asp:Label ID="lblUpdateConfirm" runat="server" CssClass="alert-danger" />
            </td>
        </tr>
    </table>
