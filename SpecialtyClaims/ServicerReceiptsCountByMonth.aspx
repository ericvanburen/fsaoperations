<%@ Page Title="Servicer Receipt Report - Specialty Claims" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="ServicerReceiptsCountByMonth.aspx.vb" Inherits="SpecialtyClaims_ServicerReceipts" EnableEventValidation="false" %>
...
<br />
<asp:SqlDataSource ID="dsServicerReceiptReport" runat="server" SelectCommand="p_ReportServicerReceiptCountByMonth"    
...
<div class="panel panel-primary">
    <div class="panel-heading">
        <span class="panel-title">FSA Receipt By Month Report</span>
    </div>
    ...
    <br />
        <asp:GridView ID="GridView1" runat="server" DataSourceID="dsServicerReceiptReport" AllowSorting="true"
        AutoGenerateColumns="false" CssClass="table">
        <Columns>
            <asp:BoundField DataField="Month_Received" HeaderText="Month Received" SortExpression="Month_Received"
                HeaderStyle-HorizontalAlign="Center" />
            <asp:BoundField DataField="Year_Received" HeaderText="Year Received" SortExpression="Year_Received"
                HeaderStyle-HorizontalAlign="Center" />
            <asp:BoundField DataField="DischargeType" HeaderText="Discharge Type" SortExpression="DischargeType"
                HeaderStyle-HorizontalAlign="Center" />                        
            <asp:BoundField DataField="Claims_Received" HeaderText="Claims Received" SortExpression="Claims_Received"
                HeaderStyle-HorizontalAlign="Center" />            
        </Columns>
    </asp:GridView>
</div>
