<%@ Page Title="Aging Claims Report" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="AgingClaims.aspx.vb" Inherits="SpecialtyClaims_AgingClaims" EnableEventValidation="false" %>
...
<br />
<asp:SqlDataSource ID="dsAgingClaimsReport" runat="server" SelectCommand="p_ReportAgingClaims"    
  SelectCommandType="StoredProcedure" ConnectionString="<%$ ConnectionStrings:SpecialtyClaimsConnectionString %>">       
</asp:SqlDataSource>

<div class="panel panel-primary">
    <div class="panel-heading">
        <span class="panel-title">Aging Claims Report</span>
    </div>
