...
Partial Class DMCSRefunds_MyRefunds
    ...
    Sub btnUpdate_Click(sender As Object, e As EventArgs)
        If Page.IsValid Then
            ...
            If chkApprove.Checked = False And txtComments.Text = "" Then
                lblUpdateConfirm.Text = "Comments are required if claim is not approved"
                Me.ModalPopupExtender1.Show()
            Else
                Dim con As SqlConnection
                Dim cmd As SqlCommand
                ...
                Try
                    ...
                    GridView1.DataBind()
                    lblUpdateConfirm.Text = "Your claim was updated"
                Finally
                    con.Close()
                End Try
            End If
        ...
        Try
            ...
            Using con
                ...
                While dr.Read()
                    ...
                    'Clear the Comments box first before loading any new values
                    txtComments.Text = ""
