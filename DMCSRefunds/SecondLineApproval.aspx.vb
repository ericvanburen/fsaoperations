...
Partial Class DMCSRefunds_SecondLineApproval
    ...
    Public Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Load
        If Not Page.IsPostBack Then
            ...
            dsSecondLineApprovalQueue.SelectParameters("SecondLineApprovalStatus").DefaultValue = ddlSecondLineApprovalStatus.SelectedValue

        End If
    End Sub

    Protected Sub ddlSecondLineApprovalStatus_SelectedIndexChanged(sender As Object, e As System.EventArgs) Handles ddlSecondLineApprovalStatus.SelectedIndexChanged
        dsSecondLineApprovalQueue.SelectParameters("SecondLineApprovalStatus").DefaultValue = ddlSecondLineApprovalStatus.SelectedValue
        dsSecondLineApprovalQueue.DataBind()
    End Sub
        ...
        Try
            ...
            Using con
                ...
                While dr.Read()
                    ...
                    ddlSecondLineApprovalStatusForm.SelectedValue = dr("SecondLineApprovalStatus").ToString()
    ...
    Sub btnUpdate_Click(ByVal Sender As Object, ByVal e As EventArgs)
        ...
        cmd = New SqlCommand("p_RefundID_SecondLineUpdate", strSQLConn)
        cmd.CommandType = CommandType.StoredProcedure

        cmd.Parameters.AddWithValue("@RefundID", lblRefundID.Text)
        cmd.Parameters.AddWithValue("@SecondLineApprovalStatus", ddlSecondLineApprovalStatusForm.SelectedValue)
        cmd.Parameters.AddWithValue("@SecondLineApprovedBy", ddlSecondLineApprovedBy.SelectedValue)
        If ddlSecondLineApprovalStatusForm.SelectedValue = "Approved" OrElse ddlSecondLineApprovalStatus.SelectedValue = "Denied" Then
